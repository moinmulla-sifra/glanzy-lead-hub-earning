...
function d() {
  return typeof window > `u`
    ? `dark`
    : window.localStorage.getItem(`glanzy-theme`) === `light`
      ? `light`
      : `dark`;
}
function f(e) {
...
var p = `try{var t=localStorage.getItem('${u}');document.documentElement.setAttribute('data-theme',t==='light'?'light':'dark');}catch(e){document.documentElement.setAttribute('data-theme','dark');}`;
export { c as a, r as c, l as i, f as n, s as o, d as r, a as s, p as t };
