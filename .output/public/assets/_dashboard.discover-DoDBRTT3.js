...
import { n as i, r as a, t as o } from "./sliders-horizontal-vP1He6xO.js";
import { t as s } from "./useMutation-CYY_aFUu.js";
import { S as c, r as l, x as u } from "./index-Difz8PWa.js";
import { a as d, n as f } from "./phone-CA_HO8J9.js";
import { t as p } from "./supabase-DTorYgRt.js";
import { t as m } from "./useMonetization-C0l42Clg.js";
import { t as h } from "./createLucideIcon-CEGepnBf.js";
import { t as g } from "./check-CCy2ox4b.js";
import { n as _, t as v } from "./BrandProfileModal-CIbb-wAf.js";
import { t as y } from "./loader-circle-LmZjNfAe.js";
import { t as b } from "./search-B10CUpjR.js";
import { t as x } from "./sparkles-C-wfMPnb.js";
import { t as S } from "./trending-up-9fTZhAs5.js";
import { t as C } from "./x-_CKTk_uH.js";
var w = h(`circle-alert`, [
  ...
  E = e(t(), 1),
  D = n();
function O({ userId: e, onStartOutreach: t }) {
  let n = u(),
    [c, h] = (0, E.useState)(``),
    [O, k] = (0, E.useState)(``),
    [A, j] = (0, E.useState)(!1),
    ...
    [I, L] = (0, E.useState)(`best_match`);
  (0, E.useEffect)(() => {
    let e = setTimeout(() => k(c.trim()), 400);
    return () => clearTimeout(e);
  }, [c]);
  let { workspaceId: R } = m(e),
    z =
      r({
        queryKey: [`saved_brands_ids`, R],
        enabled: !!R,
        queryFn: async () => {
          let { data: e, error: t } = await p
            ...
            .eq(`workspace_id`, R);
          if (t) throw t;
          return new Set(e.map((e) => e.brand_id));
        },
      }).data || new Set(),
    {
      data: B,
      ...
      queryKey: [`brands`, O, P, I],
      queryFn: async ({ pageParam: e = 0 }) => {
        let t = p.from(`brands`).select(d, { count: `exact` });
        switch (
          (O &&
            (t = t.or(
              `company_name.ilike.%${O}%,industry.ilike.%${O}%,country.ilike.%${O}%`,
            )),
          P.industry.length > 0 && (t = t.in(`industry`, P.industry)),
          P.country.length > 0 && (t = t.in(`country`, P.country)),
          P.company_stage.length > 0 &&
            (t = t.in(`company_stage`, P.company_stage)),
          P.budget_potential.length > 0 &&
            (t = t.in(`budget_potential`, P.budget_potential)),
          I)
        ) {
          case `lead_score`:
            t = t.order(`lead_score`, { ascending: !1, nullsFirst: !1 });
            break;
          case `creator_fit`:
            t = t.order(`influencer_fit_score`, {
              ascending: !1,
              nullsFirst: !1,
            });
            break;
          case `recent`:
            t = t.order(`updated_at`, { ascending: !1 });
            break;
          case `az`:
            t = t.order(`company_name`, { ascending: !0 });
            break;
          default:
            t = t
              .order(`lead_score`, { ascending: !1, nullsFirst: !1 })
              .order(`influencer_fit_score`, { ascending: !1, nullsFirst: !1 });
        }
        t = t.range(e * 12, (e + 1) * 12 - 1);
        let { data: n, error: r, count: i } = await t;
        if (r) throw r;
        return {
          brands: n,
          totalCount: i || 0,
          nextPage: n.length === 12 ? e + 1 : void 0,
        };
      },
      initialPageParam: 0,
      getNextPageParam: (e) => e.nextPage,
    }),
    K = B?.pages.flatMap((e) => e.brands) || [],
    q = B?.pages[0]?.totalCount || 0,
    J = s({
      mutationFn: async (e) => {
        if (!R) throw Error(`No workspace found`);
        if (z.has(e)) {
          let { error: t } = await p
            .from(`saved_brands`)
            .delete()
            .match({ workspace_id: R, brand_id: e });
          if (t) throw t;
          return { action: `unsaved`, brandId: e };
        }
        {
          let { error: t } = await p
            .from(`saved_brands`)
            .insert({ workspace_id: R, brand_id: e, status: `Saved` });
          if (t) throw t;
          return { action: `saved`, brandId: e };
        }
      },
      onSuccess: (e) => {
        (e.action === `saved`
          ? l.success(`Brand saved to Outreach pipeline`)
          : l.success(`Brand removed from pipeline`),
          n.invalidateQueries({ queryKey: [`saved_brands_ids`] }),
          n.invalidateQueries({ queryKey: [`saved_brands_query`] }),
          n.invalidateQueries({ queryKey: [`outreach`] }));
      },
      onError: (e) => {
        l.error(e.message || `Could not update saved status`);
      },
    }),
    Y = (e, t) => {
      F((n) => {
    ...
    X = () => {
      F({ industry: [], country: [], company_stage: [], budget_potential: [] });
    },
    Z = Object.values(P).reduce((e, t) => e + t.length, 0);
  return (0, D.jsxs)(`div`, {
    ...
    children: [
          ...
          (0, D.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, D.jsxs)(`div`, {
                ...
                ${A || Z > 0 ? `bg-brand/10 text-brand` : `bg-muted/50 text-foreground hover:bg-muted`}
              `,
                    children: [
                      (0, D.jsx)(o, { className: `w-4 h-4` }),
                      `Filters`,
                      Z > 0 &&
                        (0, D.jsx)(`span`, {
                  ...
                  (0, D.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, D.jsx)(i, {
                        className: `absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground pointer-events-none group-hover:text-foreground`,
                      }),
                    ],
                  }),
                ],
                      ...
                      `div`,
                      {
                        children: [
                          ...
                          (0, D.jsx)(`div`, {
                            ...
                            ${n ? `bg-brand border-brand` : `border-input group-hover:border-brand/50`}
                          `,
                                      children:
                                        n &&
                                        (0, D.jsx)(g, {
                                    ...
                                    (0, D.jsx)(`span`, {
                                      className: `text-sm ${n ? `text-foreground font-medium` : `text-muted-foreground`}`,
                                      children: t,
                                    }),
                                    (0, D.jsx)(`input`, {
                                      type: `checkbox`,
      ...
      (0, D.jsx)(`div`, {
        ...
        children: (0, D.jsx)(`p`, {
          ...
          children: W
            ? `Searching...`
            : (0, D.jsxs)(D.Fragment, {
                children: [q === 1 ? `1 brand` : `${q} brands`, ` found`],
              }),
        }),
      }),
      G
        ? (0, D.jsxs)(`div`, {
            ...
            children: [
              (0, D.jsx)(w, { className: `w-12 h-12 text-destructive mb-4` }),
              (0, D.jsx)(`h2`, {
              ...
              (0, D.jsx)(`button`, {
                onClick: () => n.invalidateQueries({ queryKey: [`brands`] }),
                ...
                (0, D.jsxs)(
                  `div`,
                  {
                    ...
                    children: [
                      ...
                      (0, D.jsx)(`div`, {
                        className: `h-11 w-full bg-muted rounded-xl mt-6`,
                      }),
                    ],
                  },
                  t,
            ...
            ? (0, D.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, D.jsx)(`h2`, {
                    ...
                    children: O || Z > 0 ? `No brands found` : `No brands yet`,
                  }),
                  (0, D.jsx)(`p`, {
                ...
                children: [
                  (0, D.jsx)(`div`, {
                    ...
                    children: K.map((e) => {
                      ...
                      return (
                        e.recent_funding
                          ? (n = { text: `Recent Funding`, type: `success` })
                          : e.recent_launch
                            ? (n = { text: `Recent Launch`, type: `info` })
                            : e.existing_creator_activity &&
                              (n = {
                        ...
                        (0, D.jsx)(
                          ...
                          ${n.type === `success` ? `bg-green-500/10 text-green-600 dark:text-green-400` : n.type === `info` ? `bg-blue-500/10 text-blue-600 dark:text-blue-400` : `bg-orange-500/10 text-orange-600 dark:text-orange-400`}
                        `,
                                      children: [
                                        (0, D.jsx)(x, { className: `w-3 h-3` }),
                                        n.text,
                                      ],
                                    }),
                                  }),
                                e.influencer_fit_score != null &&
                                  (0, D.jsxs)(`div`, {
                          ...
                          ${t ? `bg-muted text-foreground border border-border/50 hover:bg-destructive/10 hover:text-destructive hover:border-destructive/20 group/btn` : `bg-brand text-brand-foreground hover:bg-brand/90 shadow-sm hover:shadow-md`}
                        `,
                                    children:
                                      J.isPending && J.variables === e.id
                                        ? (0, D.jsx)(y, {
                                        ...
                                        : t
                                          ? (0, D.jsxs)(D.Fragment, {
                                              children: [
                                                (0, D.jsx)(g, {
                                                  className: `w-4 h-4 group-hover/btn:hidden`,
                                                }),
                                                (0, D.jsx)(C, {
                                                  className: `w-4 h-4 hidden group-hover/btn:block`,
                                                }),
                                                (0, D.jsx)(`span`, {
      ...
      (0, D.jsx)(v, {
        ...
        isOpen: !!M,
        onClose: () => N(null),
        isSaved: M ? z.has(M.id) : !1,
        isSaving: M ? J.isPending && J.variables === M.id : !1,
        onSave: () => M && J.mutate(M.id),
        onStartOutreach: () => {
          M && t && (N(null), t(M.id));
        },
      }),
...
function k() {
  let [e, t] = (0, E.useState)(null),
    n = c();
  return (
    (0, E.useEffect)(() => {
      p.auth.getSession().then(({ data: e }) => {
        e.session && t(e.session.user.id);
      });
    }, []),
    (0, D.jsx)(O, {
      userId: e,
      onStartOutreach: (e) => n({ to: `/contacted`, search: { brandId: e } }),
    })
  );
}
