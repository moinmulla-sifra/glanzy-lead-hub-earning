...
import { t as g } from "./calendar-DJ3ZQlXp.js";
import { t as _ } from "./check-CCy2ox4b.js";
import { n as v, t as y } from "./BrandProfileModal-CIbb-wAf.js";
import { t as b } from "./loader-circle-LmZjNfAe.js";
import { t as x } from "./search-B10CUpjR.js";
import { t as S } from "./send-C1wOFq8M.js";
import { t as C } from "./sparkles-C-wfMPnb.js";
import { t as w } from "./x-_CKTk_uH.js";
var T = h(`trash-2`, [
...
function O({ userId: e, onStartOutreach: t }) {
  let n = u(),
    ...
    [I, L] = (0, E.useState)(`recently_saved`);
  (0, E.useEffect)(() => {
  ...
  let { workspaceId: R } = m(e),
    {
      ...
      queryKey: [`saved_brands_query`, R, O, P, I],
      queryFn: async ({ pageParam: e = 0 }) => {
        ...
        let t = p
          ...
          .select(
            `
        *,
        brand:brand_id!inner (${d})
      `,
            { count: `exact` },
          )
          .eq(`workspace_id`, R);
        switch (
          (P.status.length > 0 && (t = t.in(`status`, P.status)),
          P.industry.length > 0 && (t = t.in(`brand.industry`, P.industry)),
          P.country.length > 0 && (t = t.in(`brand.country`, P.country)),
          P.company_stage.length > 0 &&
            (t = t.in(`brand.company_stage`, P.company_stage)),
          P.budget_potential.length > 0 &&
            (t = t.in(`brand.budget_potential`, P.budget_potential)),
          O &&
            (t = t.or(
    ...
    G = z?.pages.flatMap((e) => e.savedBrands) || [],
    K = z?.pages[0]?.totalCount || 0,
    q = s({
      mutationFn: async (e) => {
        let { error: t } = await p.from(`saved_brands`).delete().eq(`id`, e);
        if (t) throw t;
        return e;
      },
      onSuccess: () => {
        (l.success(`Brand removed from Saved`),
      ...
      onError: (e) => {
        l.error(e.message || `Could not remove brand`);
      },
    }),
    J = (e, t) => {
      F((n) => {
    ...
    X = Object.values(P).reduce((e, t) => e + t.length, 0),
    Z = {
      industry: [
        `Beauty`,
        `Fashion`,
  ...
  return (0, D.jsxs)(`div`, {
    ...
    children: [
          ...
          (0, D.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, D.jsxs)(`div`, {
                ...
                ${A || X > 0 ? `bg-brand/10 text-brand` : `bg-muted/50 text-foreground hover:bg-muted`}
              `,
                    children: [
            ...
            (0, D.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, D.jsx)(`div`, {
                  ...
                  children: Object.entries(Z).map(([e, t]) =>
                    (0, D.jsxs)(
                      `div`,
                      {
                        children: [
      ...
      (0, D.jsx)(`div`, {
        ...
        children: (0, D.jsx)(`p`, {
          ...
          children: U
            ? `Loading...`
            : (0, D.jsx)(D.Fragment, {
                children: K === 1 ? `1 saved brand` : `${K} saved brands`,
              }),
        }),
      }),
      W
        ? (0, D.jsxs)(`div`, {
            ...
            children: [
              (0, D.jsx)(b, { className: `w-12 h-12 text-destructive mb-4` }),
              (0, D.jsx)(`h2`, {
                  ...
                  children: [
                    (0, D.jsx)(`div`, {
                      ...
                      children: G.map((e) => {
                        ...
                        return (
                          n.recent_funding
                            ? (r = { text: `Recent Funding`, type: `success` })
                            : n.recent_launch
                              ? (r = { text: `Recent Launch`, type: `info` })
                              : n.existing_creator_activity &&
                                (r = {
                                ...
                                children: [
                                  (0, D.jsxs)(`div`, {
                                    ...
                                    children: [
                                      ...
                                      (0, D.jsx)(`div`, {
                                        className: `flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] uppercase font-bold tracking-wider border shrink-0 ${Q(e.status)}`,
                                        children: e.status,
                                      }),
                                    ],
                                  }),
                          ...
                          ${r.type === `success` ? `bg-green-500/10 text-green-600 dark:text-green-400` : r.type === `info` ? `bg-blue-500/10 text-blue-600 dark:text-blue-400` : `bg-orange-500/10 text-orange-600 dark:text-orange-400`}
                        `,
                                        children: [
                                          (0, D.jsx)(C, {
                                            className: `w-3 h-3`,
                                  ...
                                  (0, D.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, D.jsx)(`button`, {
                                        disabled:
                                          q.isPending && q.variables === e.id,
                                        onClick: () => q.mutate(e.id),
      ...
      (0, D.jsx)(y, {
        ...
        onClose: () => N(null),
        isSaved: !0,
        isSaving: M ? q.isPending && q.variables === M.id : !1,
        onSave: () => {
          M && (q.mutate(M.id), N(null));
        },
        onStartOutreach: () => {
          M && t && (N(null), t(M.brand.id));
        },
      }),
    ],
  });
