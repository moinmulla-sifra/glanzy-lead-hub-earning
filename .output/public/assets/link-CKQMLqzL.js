...
import { t as i } from "./useRouter-CwjitLz4.js";
function a(e) {
...
function v(e, t, n) {
  ...
  if (Array.isArray(e) && Array.isArray(t)) {
    ...
    for (let r = 0, i = e.length; r < i; r++) if (!v(e[r], t[r], n)) return !1;
    return !0;
  }
  if (h(e) && h(t)) {
    ...
    let a = 0;
    for (let o in t)
      if ((!r || t[o] !== void 0) && (a++, a > i || !v(e[o], t[o], n)))
        return !1;
    return i === a;
  }
  return !1;
...
function O(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    i;
  for (; (i = t.exec(e)) !== null;)
    ((r += S(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += S(n ? e.slice(n) : e);
  let a = !1;
  return (
...
var A = 4,
  re = 5;
function ie(e, t, n = new Uint16Array(6)) {
  let r = e.indexOf(`/`, t),
    i = r === -1 ? e.length : r,
    a = e.substring(t, i);
  if (!a || !a.includes(`$`))
...
function se(e, t, n = !1) {
  ...
  let a;
  try {
    a = R(e, t.segmentTree, n);
  } catch (e) {
    if (e instanceof URIError) a = null;
    else throw e;
  }
  return (a && (a.branch = B(a.route)), t.matchCache.set(r, a), a);
}
function I(e) {
...
function L(e, t = !1, n) {
  let r = M(e.fullPath),
    ...
    c = 0;
  j(t, i, e, 1, r, 0, a, (e) => {
    if ((n?.(e, c), e.id in o && ne(), (o[e.id] = e), c !== 0 && e.path)) {
      let t = I(e.fullPath);
...
function H(e, t, n, r) {
  ...
  for (; c.length;) {
    ...
    r && i.route && i.kind !== A && G(l, n) && (l = n);
    let _ = o === s;
    if (
      _ &&
      (i.route && (!a || i.kind === A || i.kind === 2) && G(u, n) && (u = n),
...
function K(e) {
  return q(e.filter((e) => e !== void 0).join(`/`));
}
function q(e) {
...
function de({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  if ((t.includes(`//`) && (t = q(t)), t.startsWith(`/`)))
  ...
  s.length > 1 &&
    (o(s) === `` ? n === `never` && s.pop() : n === `always` && s.push(``));
  let c = s.join(`/`),
    l = (i ? q(c) : c) || `/`;
...
var xe = r();
function Se({ children: e, fallback: t = null }) {
  return (0, xe.jsx)(Z.Fragment, { children: Ce() ? e : t });
}
function Ce() {
...
function Ae(e, t, n = ke) {
  ...
  return (0, Oe.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
function je(e) {
  let t = Z.useRef(e);
  return (
    v(t.current, e, { ignoreUndefined: !1 }) || (t.current = e),
    t.current
  );
}
function Me(e, t) {
...
function Ne(e, t, n) {
  if (e?.external) return w(e.href, n) ? void 0 : e.href;
  if (!He(t) && a(t)) return w(t, n) ? void 0 : t;
}
function Pe(e, t, n, r, i, a) {
  if (a) return !1;
  if (n?.exact) {
    if (!ue(e.pathname, t.pathname, r)) return !1;
  } else {
    let n = X(e.pathname, r),
      i = X(t.pathname, r);
...
function Fe(e, t) {
    ...
    R = Z.useCallback(
      (e) => {
        let t = n.buildLocation({ _fromLocation: e, ...L }),
          ...
          i = Ne(r, P, n.protocolAllowlist);
        return [r?.href, i, Pe(e, t, I, n.basepath, F, i !== void 0)];
      },
      [I, b, F, L, n, P],
    ),
    [z, B, V] = Ae(n.stores.location, R, Me),
    H = V ? (s(a, {}) ?? Le) : Ie,
    U = V ? Ie : (s(o, {}) ?? Ie),
    ce = [S, H.className, U.className].filter(Boolean).join(` `),
    W = (x || H.style || U.style) && { ...x, ...H.style, ...U.style },
    G = Z.useRef(!1),
    K = e.reloadDocument || B || b ? !1 : (u ?? n.options.defaultPreload),
    q = d ?? n.options.defaultPreloadDelay ?? 0,
    J = Z.useCallback(() => {
      n.preloadRoute(L).catch((e) => {
        (console.warn(e), console.warn(ge));
      });
    }, [n, L]),
    Y = Z.useCallback(
      (e) => {
        ...
        if (!(e.isIntersecting ?? K === `intent`)) {
          e.isIntersecting === !1 && Be(r);
          return;
        }
        if (!q) {
          J();
  ...
  (ye(r, Y, K !== `viewport`),
    Z.useEffect(() => {
      G.current || (K === `render` && (J(), (G.current = !0)));
    }, [J, K]));
  let le = (e) => {
