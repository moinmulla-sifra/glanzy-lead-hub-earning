...
import { a as n, c as r, i, o as a, s as o, t as s } from "./theme-DjMA5HfB.js";
import {
  D as c,
  _ as l,
  a as u,
...
` +
    ...
    function Dr(e, t, n) {
      e === `focusin`
        ? (Tr(), (_r = t), (vr = n), _r.attachEvent(`onpropertychange`, Er))
        : e === `focusout` && Tr();
    }
    function Or(e) {
    ...
    var Yr = k(`animationend`),
      Xr = k(`animationiteration`),
      Zr = k(`animationstart`),
      Qr = k(`transitionrun`),
      $r = k(`transitionstart`),
      ei = k(`transitioncancel`),
      ti = k(`transitionend`),
      ni = new Map(),
      ri =
    ...
    function Ao(e, t, n, r) {
      ...
      do {
        if ((xo && (To = null), (wo = 0), (xo = !1), 25 <= i))
          throw Error(a(301));
        if (((i += 1), (yo = I = null), e.updateQueue != null)) {
          var o = e.updateQueue;
          ((o.lastEffect = null),
            (o.events = null),
            (o.stores = null),
    ...
    function Ho(e, t, n) {
      ...
      if (((o = e.baseState), i === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Mr(o, e.memoizedState) && ((ac = !0), d && ((n = xa), n !== null)))
        )
          throw n;
        ((e.memoizedState = o),
          (e.baseState = s),
    ...
    function Wo(e, t, n) {
      ...
      var s = !Mr((I || i).memoizedState, n);
      if (
        (s && ((i.memoizedState = n), (ac = !0)),
        (i = i.queue),
        hs(qo.bind(null, r, i, e), [e]),
        i.getSnapshot !== t || s || (yo !== null && yo.memoizedState.tag & 1))
      ) {
        if (
          ((r.flags |= 2048),
    ...
    function Ps(e, t, n) {
      ...
      ((n = {
        ...
        Rs(e)
          ? zs(t, n)
          : ((n = di(e, t, n, r)), n !== null && (hu(n, e, r), V(n, t, r))));
    }
    function Fs(e, t, n) {
      Is(e, t, n, pu());
    }
    ...
    function lc(e, t, n, r) {
      ...
      if (
        ...
        a === null
          ? (e !== null && Oa(t, null), so(), ho(t))
          : (Oa(t, a.cachePool), oo(t, a), ho(t), (t.memoizedState = null));
    ...
    function mc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((po(t), i))
          ...
          (ac || oa(e, t, n, !1), (i = (n & e.childLanes) !== 0), ac || i)
        ) {
          if (
            ((r = K),
      ...
      switch (((t.lanes = 0), t.tag)) {
        ...
        case 3:
          a: {
            ...
            ((i = o.element), N(e, t), to(t, r, null, n));
    ...
    function zc(e, t, n) {
      ...
      switch ((Bi(t), t.tag)) {
        ...
        case 19:
          if ((E(P), (r = t.memoizedState), r === null)) return (U(t), null);
    ...
    function xu() {
      if (q !== null) {
        ...
        else ((e = q), (ta = ea = null), Po(e), (za = null), (Ba = 0), (e = q));
...
`,
  ...
  se = `__TSS_CONTEXT`,
  ce = Symbol.for(`TSS_SERVER_FUNCTION`),
  le = `application/x-tss-framed`,
...
var fe = () => window.__TSS_START_OPTIONS__;
function pe(e) {
  return e[e.length - 1];
}
function me(e) {
...
function ge(e) {
  for (let t in e) if (E.call(e, t)) return !0;
  return !1;
}
...
function we(e, t, n) {
  ...
  if (Array.isArray(e) && Array.isArray(t)) {
    ...
    for (let r = 0, i = e.length; r < i; r++) if (!we(e[r], t[r], n)) return !1;
    return !0;
  }
  if (xe(e) && xe(t)) {
    ...
    if (n?.partial) {
      for (let i in t)
        if ((!r || t[i] !== void 0) && !we(e[i], t[i], n)) return !1;
      return !0;
    }
    let i = 0;
    ...
    let a = 0;
    for (let o in t)
      if ((!r || t[o] !== void 0) && (a++, a > i || !we(e[o], t[o], n)))
        return !1;
    return i === a;
  }
  return !1;
...
function Ie(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    i;
  for (; (i = t.exec(e)) !== null;)
    ((r += Ae(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += Ae(n ? e.slice(n) : e);
  let a = !1;
  return (
...
function Ge(e, t, n, r, i, a, o) {
      ...
      switch (((s = d + 1), a++, e[0])) {
        ...
        case 1: {
          ...
          if (h) o = h;
            ...
            let e = Ye(1, n.fullPath ?? n.from, f, p, m);
            ((o = e),
              (e.depth = a),
              (e.parent = i),
              (i.dynamic ??= []),
        ...
        case 3: {
          ...
          if (h) o = h;
            ...
            let e = Ye(3, n.fullPath ?? n.from, f, p, m);
            ((o = e),
              (e.parent = i),
              (e.depth = a),
              (i.optional ??= []),
        ...
        case 2: {
          let t = r.substring(u, e[1]),
            ...
            m = Ye(2, n.fullPath ?? n.from, l, f, p);
          ((o = m),
            (m.parent = i),
            (m.depth = a),
            (i.wildcard ??= []),
  ...
  if (n.children) for (let r of n.children) Ge(e, t, r, s, i, a, o);
}
function Ke(e, t) {
...
function qe(e) {
  if (e.pathless) for (let t of e.pathless) qe(t);
  if (e.static) for (let t of e.static.values()) qe(t);
  if (e.staticInsensitive) for (let t of e.staticInsensitive.values()) qe(t);
  if (e.dynamic?.length) {
    e.dynamic.sort(Ke);
    for (let t of e.dynamic) qe(t);
  }
  if (e.optional?.length) {
    e.optional.sort(Ke);
    for (let t of e.optional) qe(t);
  }
  if (e.wildcard?.length) {
    e.wildcard.sort(Ke);
    for (let t of e.wildcard) qe(t);
  }
}
function Je(e) {
  return {
...
function Xe(e, t) {
  let n = Je(`/`),
    r = new Uint16Array(6);
  for (let t of e) Ge(!1, r, t, 1, n, 0);
  (qe(n), (t.masksTree = n), (t.flatCache = Be(1e3)));
}
function Ze(e, t) {
  e ||= `/`;
  let n = t.flatCache.get(e);
  if (n) return n;
  let r = nt(e, t.masksTree);
...
function Qe(e, t, n, r, i) {
  ...
  return (
    o ||
      ((o = Je(`/`)),
      Ge(t, new Uint16Array(6), { from: e }, 1, o, 0),
...
function $e(e, t, n = !1) {
  ...
  let a;
  try {
    a = nt(e, t.segmentTree, n);
  } catch (e) {
    if (e instanceof URIError) a = null;
    else throw e;
  }
  return (a && (a.branch = it(a.route)), t.matchCache.set(r, a), a);
}
function et(e) {
...
function tt(e, t = !1, n) {
  ...
  return (
    Ge(t, i, e, 1, r, 0, (e) => {
      if ((n?.(e, s), e.id in a && ze(), (a[e.id] = e), s !== 0 && e.path)) {
        let t = et(e.fullPath);
...
function ot(e, t, n, r) {
  ...
  for (; s.length;) {
    ...
    if (i.kind === 2 && i.route && !ut(l, n)) continue;
    if (i.parse) {
      if (!lt(e, t, n)) continue;
      ((_ = n.rawParams), (g = n.extract));
    }
    r && i.route && i.kind !== Ve && ut(c, n) && (c = n);
    let v = u === o;
    if (
      v &&
      (i.route && (!a || i.kind === Ve || i.kind === 2) && ut(l, n) && (l = n),
    ...
    if (v && i.index) {
      let n = {
        ...
        r = !0;
      if ((i.index.parse && (lt(e, t, n) || (r = !1)), r)) {
        if (!m && !h && !d && ct(p, o)) return n;
        ut(l, n) && (l = n);
      }
    }
    if (i.wildcard)
...
function dt(e) {
  return ft(e.filter((e) => e !== void 0).join(`/`));
}
function ft(e) {
...
function _t(e, t, n) {
  return gt(e, n) === gt(t, n);
}
function vt({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  let i = t.startsWith(`/`),
    a = !i && t === `.`,
    o;
  if (r) {
  ...
  if (a) s = e.split(`/`);
    ...
    for (s = e.split(`/`); s.length > 1 && pe(s) === ``;) s.pop();
    let n = t.split(`/`);
  ...
  s.length > 1 &&
    (pe(s) === `` ? n === `never` && s.pop() : n === `always` && s.push(``));
  let c = ft(s.join(`/`)) || `/`;
...
function xt({ path: e, params: t, decoder: n, ...r }) {
  let i = !1,
    a = Object.create(null);
  if (!e || e === `/`)
...
function Ot() {
  try {
    Et?.setItem(Tt, JSON.stringify(kt));
  } catch {}
}
var kt = Dt(),
  At = `data-scroll-restoration-id`,
  jt = (e) => e.state.__TSR_key || e.href;
function Mt(e) {
...
function Lt(e, t) {
  let n = t ?? e.options.scrollRestoration,
    r = e._scroll;
  n && (r.restoring = !0);
  let i = e.options.getScrollRestorationKey || jt,
    a = new Set(),
    o = (e) => {
      let t = (kt[e] ||= {});
      for (let e of a)
        e === document
          ? (t[Pt] = { scrollX, scrollY })
          : e.isConnected &&
            (t[Mt(e)] = { scrollX: e.scrollLeft, scrollY: e.scrollTop });
    };
  (n &&
    !r.restoration &&
    ((r.restoration = !0),
          ...
          if (e) {
            ...
            for (let n in e) {
              if (n === Pt) {
                ...
                let e = Ft(n);
                if (!e || (s && o && ((l ??= It(o)), l.has(e)))) continue;
              }
              ((t ||= kt[u] = {}), (t[n] ??= e[n]));
            }
          }
...
var Vt = Ut(JSON.parse),
  Ht = Wt(JSON.stringify, JSON.parse);
function Ut(e) {
  return (t) => {
    t[0] === `?` && (t = t.substring(1));
    let n = Bt(t);
...
function Xt(e) {
  ...
  return {
    ...
    output: ({ url: e }) => ((e.pathname = dt([`/`, t, e.pathname])), e),
  };
}
function Zt(e, t) {
  let n = e?.input?.({ url: t });
...
var nn = (e) => {
  ...
  an = (e, t) => !!(e.preload && !e.router.stores.matchStores.has(t)),
  on = (e, t, n = !0) => {
  ...
  cn = (e, t, n) => {
    if (!(!qt(n) && !Ct(n)))
      throw qt(n) && n.redirectHandled && !n.options.reloadDocument
        ? n
        : (t &&
  ...
  dn = (e, t, n) => {
    ...
    ((e.firstBadMatchIndex ??= t), cn(e, e.router.getMatch(r), n));
    try {
      a.options.onError?.(n);
    } catch (t) {
      ((n = t), cn(e, e.router.getMatch(r), n));
    }
    (e.updateMatch(
      r,
      (e) => (
      ...
      !e.preload && !qt(n) && !Ct(n) && (e.serialError ??= n));
  },
  fn = (e, t, n, r) => {
  ...
  mn = (e, t, n, r) => {
    ...
    i._nonReactive.loadPromise = Te(() => {
      (a?.resolve(), (a = void 0));
    });
    let { paramsError: o, searchError: s } = i;
    (o && dn(e, n, o), s && dn(e, n, s), fn(e, t, r, i));
    ...
    i._nonReactive.beforeLoadPromise = Te();
    let f = { ...on(e, n, !1), ...i.__routeContext },
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          ((o = t), cn(e, e.router.getMatch(n), t));
        }
        (!qt(o) && !Ct(o) && (await Sn(i, [`errorComponent`])),
          e.updateMatch(n, (t) => ({
            ...t,
            error: o,
            context: on(e, r),
      ...
      (r && (r._nonReactive.loaderPromise = void 0), cn(e, r, t));
    }
  },
  yn = async (e, t, n) => {
    async function r(r, a, c, l, d) {
      let f = Date.now() - a.updatedAt,
        ...
        h = typeof m == `function` ? m(_n(e, t, i, n, d)) : m,
            ...
            ? ((s = !0),
              (async () => {
                try {
                  ...
                  qt(t) && (await e.router.navigate(t.options));
                }
              })())
            : g !== `success` || o
              ? await vn(e, t, i, n, d)
    ...
    if (ln(e, i)) {
      ...
      if (t._nonReactive.loaderPromise) {
        ...
        (a && cn(e, n, a), n.status === `pending` && (await r(l, t, s, n, c)));
      } else {
        let n = l && !e.router.stores.matchStores.has(i),
          a = e.router.getMatch(i);
        ((a._nonReactive.loaderPromise = Te()),
...
async function bn(e) {
  ...
  let i = t.firstBadMatchIndex ?? t.matches.length,
    a = r && !t.preload ? sn(t, r) : void 0,
    o = r && t.preload ? 0 : a === void 0 ? i : Math.min(a + 1, i),
    s,
    c;
  for (let e = 0; e < o; e++) n.push(yn(t, n, e));
  try {
    await Promise.all(n);
  } catch {
...
function Cn(e) {
  for (let t of wn) if (e.options[t]?.preload) return !0;
  return !1;
}
var wn = [
    `component`,
...
function kn(e, t) {
  t ||= {};
  let n = Nn();
  return { ...t, key: n, __TSR_key: n, [Tn]: e };
}
function An(e) {
  ...
  if (!t.history.state?.__TSR_key && !t.history.state?.key) {
    let e = Nn();
    t.history.replaceState({ [Tn]: 0, key: e, __TSR_key: e }, ``);
  }
  let l = c(),
    u,
    d = !1,
    ...
    C = On({
      ...
      destroy: () => {
        ((t.history.pushState = n),
          ...
          t.removeEventListener(Dn, S, { capture: !0 }),
          t.removeEventListener(En, x));
      },
      onBlocked: () => {
        u && l !== u && (l = u);
      },
  ...
  return (
    t.addEventListener(Dn, S, { capture: !0 }),
    t.addEventListener(En, x),
...
function Mn(e, t) {
  ...
  return {
    ...
    state: t || { [Tn]: 0, key: a, __TSR_key: a },
  };
}
function Nn() {
...
var In = class {
      ...
      ((this.tempLocationKey = `${Math.round(Math.random() * 1e7)}`),
        ...
        (this.update = (e) => {
          ...
          if (!this.stores && this.latestLocation) {
            ...
            ((this.batch = e.batch),
              (this.stores = $t(zn(this.latestLocation), e)),
              Lt(this));
          }
          let a = !1,
          ...
          if (r || n !== o || i !== s) {
            ...
            (t && t !== `/` && e.push(Xt({ basepath: o })),
              s && e.push(s),
              (this.rewrite =
                e.length === 0 ? void 0 : e.length === 1 ? e[0] : Yt(e)),
              this.history && this.updateLatestLocation(),
              (a = !0));
          }
        ...
        (this.buildRouteTree = () => {
          let e = tt(this.routeTree, this.options.caseSensitive, (e, t) => {
            e.init({ originalIndex: t });
          });
          return (
            this.options.routeMasks &&
              Xe(this.options.routeMasks, e.processedTree),
            e
          );
        }),
        (this.subscribe = (e, t) => {
          ...
          let n = ({ pathname: e, search: n, hash: r, href: i, state: a }) => {
              ...
              return (
                (s.search = l),
                {
                  ...
                  publicHref: i,
                  pathname: Ie(s.pathname).path,
                  external: !!this.rewrite && s.origin !== this.origin,
                  searchStr: l,
                  search: ve(t?.search, c),
                  hash: Ie(s.hash.slice(1)).path,
                  state: ye(t?.state, a),
                }
              );
            },
        ...
        (this.buildLocation = (e) => {
          let t = (t = {}) => {
              ...
              let i =
                ...
                u =
                  t.params === !1 || t.params === null
                    ...
                    : (t.params ?? !0) === !0
                      ? s
                      : Object.assign(s, he(t.params, s)),
                d = this.routesByPath[mt(l)],
                f;
                ...
                (f.forEach((t) => {
                  if (t.options.validateSearch)
                    try {
                      Object.assign(
                        e,
                        Bn(t.options.validateSearch, { ...e, ...m }),
                      );
                    } catch {}
                }),
                  (m = e));
              ...
              let h = this.options.stringifySearch(m),
                g =
                  t.hash === !0 ? n.hash : t.hash ? he(t.hash, n.hash) : void 0,
                _ = g ? `#${g}` : ``,
                v =
                  t.state === !0
                    ? n.state
        ...
        (this.commitLocation = async ({
          ...
          let r,
            ...
            a = mt(this.latestLocation.href) === mt(n.href),
            o = this.commitLocationPromise;
          if (
            ((this.commitLocationPromise = Te(() => {
              (o?.resolve(), (o = void 0));
            })),
            a && i())
          )
        ...
        (this.buildAndCommitLocation = ({
          ...
          if (a) {
            let t = this.history.location.state.__TSR_index,
              n = Mn(a, { __TSR_index: e ? t : t + 1 }),
              r = new URL(n.pathname, this.origin);
            ((o.to = Zt(this.rewrite, r).pathname),
              ...
              this.startTransition(async () => {
                try {
                  ...
                  let n = this.latestLocation,
                    r = Fn(n, this.stores.resolvedLocation.get());
          ...
          if (
            ...
            if (typeof t == `object` && this.isViewTransitionTypesSupported) {
              let r = this.latestLocation,
                ...
                a = typeof t.types == `function` ? t.types(Fn(r, i)) : t.types;
              if (a === !1) {
                e();
                return;
              }
        ...
        this.update({
          ...
          stringifySearch: e.stringifySearch ?? Ht,
          parseSearch: e.parseSearch ?? Vt,
          protocolAllowlist: e.protocolAllowlist ?? je,
        }),
    ...
    getRouteBranch(e) {
      ...
      return (t || ((t = it(e)), this.routeBranchCache.set(e, t)), t);
    }
    get looseRoutesById() {
    ...
    matchRoutesInternal(e, t) {
      ...
      for (let n = 0; n < a.length; n++) {
        ...
        let p = r.options.loaderDeps?.({ search: u }) ?? ``,
          ...
          { interpolatedPath: h, usedParams: g } = xt({
            path: r.fullPath,
            params: i,
            decoder: this.pathParamsDecoder,
            server: this.isServer,
        ...
        if (!v)
          try {
            ...
            if (
              ((x = Ct(e) || qt(e) ? e : new Rn(e.message, { cause: e })),
              t?.throwOnError)
            )
              throw x;
          }
        ...
        if (v)
          C = {
            ...
            params: y?.params ?? i,
            _strictParams: b,
            search: ve(y ? y.search : v.search, u),
            _strictSearch: d,
          };
        else {
          let e =
          ...
          C = {
            ...
            _nonReactive: { loadPromise: Te() },
            __beforeLoadContext: void 0,
            context: {},
            abortController: new AbortController(),
            fetchCount: 0,
            cause: S,
            loaderDeps: y ? ye(y.loaderDeps, p) : p,
            invalid: !1,
            preload: !1,
            links: void 0,
            scripts: void 0,
        ...
        ((C.context = { ...ee, ...C.__routeContext, ...C.__beforeLoadContext }),
          (c[n] = C));
      }
      for (let t = 0; t < c.length; t++) {
        let n = c[t],
          ...
          o = l.get(n.routeId);
        if (((n.params = o ? ve(o.params, i) : i), !a)) {
          let i = c[t - 1],
    ...
    matchRoutesLightweight(e) {
      let t = pe(this.stores.matchesId.get()),
...
function Vn({ pathname: e, routesById: t, processedTree: n }) {
...
var Kn = Symbol.for(`TSR_DEFERRED_PROMISE`);
function qn(e, t) {
  let n = e;
  return n[Kn]
    ? n
    : ((n[Kn] = { status: `pending` }),
      n
        .then((e) => {
          ((n[Kn].status = `success`), (n[Kn].data = e));
        })
        .catch((e) => {
          ((n[Kn].status = `error`),
            (n[Kn].error = {
...
var Jn = `Error preloading route! ☝️`;
function Yn(e, t) {
...
var tr = class {
      ...
      if (
        ((this.init = (e) => {
          ...
          ((this.parentRoute = this.options.getParentRoute?.()),
            n ? (this._path = Gt) : this.parentRoute || ze());
          let r = n ? Gt : t?.path;
          r && r !== `/` && (r = pt(r));
          let i = t?.id || r,
            a = n
          ...
          (r === `__root__` && (r = `/`),
            a !== `__root__` && (a = dt([`/`, a])));
          let o = a === `__root__` ? `/` : dt([this.parentRoute.fullPath, r]);
          ((this._path = r),
            (this._id = a),
            (this._fullPath = o),
            (this._to = mt(o)));
  ...
  rr = Symbol.asyncIterator,
  ir = Symbol.hasInstance,
  ar = Symbol.isConcatSpreadable,
  or = Symbol.iterator,
  sr = Symbol.match,
  cr = Symbol.matchAll,
  lr = Symbol.replace,
  ...
  vr = { 2: !0, 3: !1, 1: void 0, 0: null, 4: -0, 5: 1 / 0, 6: -1 / 0, 7: NaN },
  yr = {
    0: `Error`,
    1: `EvalError`,
    2: `RangeError`,
...
function jr(e) {
  ...
  for (let i = 0, a = e.length; i < a; i++)
    ((r = Ar(e[i])), r && ((t += e.slice(n, i) + r), (n = i + 1)));
...
function ti(e) {
  if ($r(e)) return Zr.get(e);
  throw new Kr(e);
}
function ni(e) {
  if (ei(e)) return Qr.get(e);
  throw new qr(e);
}
typeof globalThis < `u`
...
function Si(e, t, n) {
  if (t.byteLength > yi) throw new Hr(t);
  return O(
    20,
    e,
    void 0,
...
function ea(e, t) {
  ...
  return n == null
    ? { type: 0, value: $i(e, t) }
    : (Qi(e, n), { type: 1, value: ui(n) });
}
function ta(e, t) {
  let n = ea(e, t);
  return n.type === 1 ? n : $r(t) ? { type: 2, value: hi(n.value, t) } : n;
}
function na(e, t) {
  let n = ta(e, t);
  if (n.type !== 0) return n.value;
  if (t in gr) return mi(n.value, t);
  throw new Hr(t);
}
function ra(e, t) {
  let n = ea(e, Wi[t]);
...
async function pa(e, t, n) {
  ...
  for (let n = 0, o = r.length; n < o; n++)
    (i.push(jr(r[n][0])), a.push(await M(e, t, r[n][1])));
  return (
    or in n &&
      (i.push(na(e.base, or)), a.push(Ei(ia(e.base), await M(e, t, Vi(n))))),
    rr in n &&
      (i.push(na(e.base, rr)), a.push(Di(aa(e.base), await M(e, t, qi(n))))),
    mr in n && (i.push(na(e.base, mr)), a.push(ci(n[mr]))),
    ar in n && (i.push(na(e.base, ar)), a.push(n[ar] ? Sr : Cr)),
    { k: i, v: a }
  );
}
async function ma(e, t, n, r, i) {
  return oa(n, r, i, await pa(e, t, r));
}
async function ha(e, t, n, r) {
  return vi(n, await M(e, t, r.valueOf()));
}
async function ga(e, t, n, r) {
  return bi(n, r, await M(e, t, r.buffer));
}
async function _a(e, t, n, r) {
  return xi(n, r, await M(e, t, r.buffer));
}
async function va(e, t, n, r) {
  return Si(n, r, await M(e, t, r.buffer));
}
async function ya(e, t, n, r) {
  let i = ai(r, e.base.features);
  return Ci(n, r, i ? await pa(e, t, i) : void 0);
}
async function ba(e, t, n, r) {
  let i = ai(r, e.base.features);
  return wi(n, r, i ? await pa(e, t, i) : void 0);
}
  ...
  if (i)
    for (let a = 0, o = i.length; a < o; a++) {
      ...
      if (o.parse.async && o.test(r))
        return gi(n, o.tag, await o.parse.async(r, new ua(e, t), { id: n }));
    }
}
...
async function Ea(e, t, n, r) {
  return Oi(n, ra(e.base, 4), await new Promise(Ta.bind(e, t, n, r)));
}
async function Da(e, t, n, r) {
  let i = [];
  for (let n = 0, a = r.v.length; n < a; n++) i[n] = await M(e, t, r.v[n]);
  return Mi(n, i, r.t, r.d);
}
async function Oa(e, t, n, r) {
  if (Array.isArray(r)) return fa(e, t, n, r);
  if (Gi(r)) return Ea(e, t, n, r);
  if (zi(r)) return Da(e, t, n, r);
  let i = r.constructor;
  if (i !== void 0 && typeof i != `function`) {
    let e = Object.getPrototypeOf(r);
    i = e === null ? void 0 : e.constructor;
  }
  if (i === Ni) return M(e, t, r.replacement);
  ...
  if (i === Promise || r instanceof Promise) return wa(e, t, n, r);
  let o = e.base.features;
  if (o & 32 && i === RegExp) return pi(n, r);
  if (o & 16)
    switch (i) {
      case BigInt64Array:
      case BigUint64Array:
  ...
  if (r instanceof Error) return ya(e, t, n, r);
  if (or in r || rr in r) return ma(e, t, n, r, !!i);
  throw new Hr(r);
}
...
function Ua(e) {
  return { mode: 2, base: Ha(2, e), child: void 0 };
}
var Wa = class {
  constructor(e, t) {
    ((this._p = e), (this.depth = t));
...
function qa(e, t, n) {
  return (Ga(e.base, t), e.state.marked.has(t) && e.base.refs.set(t, n), n);
}
function Ja(e, t, n) {
  return (Ga(e.base, t), e.base.refs.set(t, n), n);
}
function N(e, t, n) {
  return e.mode === 1 ? qa(e, t, n) : Ja(e, t, n);
}
function Ya(e, t, n) {
...
function $a(e, t, n, r, i) {
  if (typeof r == `string`) Qa(n, Nr(r), L(e, t, i));
  else {
    let a = L(e, t, r);
    switch (typeof a) {
      case `string`:
...
function no(e, t, n, r) {
  let i = n.k;
  if (i.length > 0)
    for (let a = 0, o = n.v, s = i.length; a < s; a++) $a(e, t, r, i[a], o[a]);
  return r;
}
function ro(e, t, n) {
  let r = N(e, n.i, n.t === 10 ? {} : Object.create(null));
  return (no(e, t, n.p, r), Ba(r, n.o), r);
}
function io(e, t) {
  return N(e, t.i, new Date(t.s));
}
function ao(e, t) {
  if (!(e.base.features & 64)) throw new Ur(t);
  let n;
  switch (t.c) {
    case 0:
...
function lo(e, t) {
  if (t.s.length > La) throw new k(t);
  return N(e, t.i, Ri(Nr(t.s)));
}
function uo(e, t, n) {
  let r = Pa(n.c),
    i = L(e, t, n.f);
  if (!(i instanceof ArrayBuffer)) throw new k(n);
  let a = n.b ?? 0;
  if (a < 0 || a > i.byteLength || n.l > La) throw new k(n);
  return N(e, n.i, new r(i, a, n.l));
}
function fo(e, t, n) {
  let r = L(e, t, n.f);
  if (!(r instanceof ArrayBuffer)) throw new k(n);
  let i = n.b ?? 0;
  if (i < 0 || i > r.byteLength || n.l > La) throw new k(n);
...
function mo(e, t, n) {
  return po(e, t, n, N(e, n.i, AggregateError([], Nr(n.m))));
}
function ho(e, t, n) {
  let r = Ya(n, br, n.s);
  return po(e, t, n, N(e, n.i, new r(Nr(n.m))));
}
function go(e, t, n) {
  let r = Pi(),
    i = N(e, n.i, r.p),
    a = L(e, t, n.f);
  if (Ka(a)) throw new k(n.f);
  return (n.s ? r.s(a) : r.f(a), i);
}
function P(e, t, n) {
  return N(e, n.i, Object(L(e, t, n.f)));
}
function _o(e, t, n) {
  ...
  if (r) {
    ...
    for (let a = 0, o = r.length; a < o; a++) {
      let o = r[a];
      if (o.tag === i)
        return N(e, n.i, o.deserialize(n.s, new Wa(e, t), { id: n.i }));
    }
  }
  throw new Wr(n.c);
}
function vo(e, t) {
  let n = N(e, t.i, N(e, t.s, Pi()).p);
  return (eo(e, t.s, 22), n);
}
function F(e, t, n) {
...
function I(e, t, n) {
  L(e, t, n.a[0]);
  let r = L(e, t, n.a[1]);
  if (!r || typeof r != `object` || !zi(r)) throw new k(n.a[1]);
  return A(r);
}
function yo(e, t, n) {
  L(e, t, n.a[0]);
  let r = L(e, t, n.a[1]);
  if (!r || typeof r != `object` || !Gi(r)) throw new k(n.a[1]);
  return Yi(r);
}
function bo(e, t, n) {
  let r = N(e, n.i, Ki());
...
function xo(e, t, n) {
  let r = e.base.refs.get(n.i);
  if (r) {
    (to(e, n, n.i, 31), r.next(L(e, t, n.f)));
    return;
  }
  throw new Gr(`Stream`);
}
function So(e, t, n) {
  let r = e.base.refs.get(n.i);
  if (r) {
    (to(e, n, n.i, 31), r.throw(L(e, t, n.f)));
    return;
  }
  throw new Gr(`Stream`);
}
function Co(e, t, n) {
  let r = e.base.refs.get(n.i);
  if (r) {
    (to(e, n, n.i, 31), r.return(L(e, t, n.f)));
    return;
  }
  throw new Gr(`Stream`);
}
...
function L(e, t, n) {
  ...
  switch (((t += 1), n.t)) {
    ...
    case 0:
      return Number(n.s);
    case 1:
      return Nr(String(n.s));
    case 3:
      if (String(n.s).length > Ra) throw new k(n);
      return BigInt(n.s);
    case 4:
...
var Mo = class {
  ...
  Po = !!No && typeof No.from == `function`;
function Fo(e) {
  if (e.length === 0) return ``;
  if (Po) return No.from(e).toString(`base64`);
  let t = 32768,
    n = [];
...
var Io = Object.create(null),
  ...
  Vo = `(s=>new ReadableStream({start(c){s.on({next(b){try{const d=atob(b),a=new Uint8Array(d.length);for(let i=0;i<d.length;i++)a[i]=d.charCodeAt(i);c.enqueue(a)}catch(_){}},throw(e){c.error(e)},return(){try{c.close()}catch(_){}}})}}))`,
  Ho = `(s=>{const e=new TextEncoder();return new ReadableStream({start(c){s.on({next(v){try{if(typeof v==='string'){c.enqueue(e.encode(v))}else{const d=atob(v.$b64),a=new Uint8Array(d.length);for(let i=0;i<d.length;i++)a[i]=d.charCodeAt(i);c.enqueue(a)}}catch(_){}},throw(x){c.error(x)},return(){try{c.close()}catch(_){}}})}})})`;
function Uo(e) {
  let t = Ki(),
    n = e.getReader();
  return (
...
var Go = ja({
  ...
  parse: {
    ...
    async async(e, t, n) {
      let r = e.hint === `text` ? Lo : Io,
        i = e.hint === `text` ? Wo(e.stream) : Uo(e.stream);
      return {
  ...
  deserialize(e, t, n) {
    ...
    return t.deserialize(e.hint) === `text` ? Bo(r) : Ro(r);
  },
});
function Ko(e) {
  return ja({
...
var qo = ja({
  ...
  Xo = ja({
    ...
    parse: {
      ...
      async async() {
        return await Promise.resolve(Jo);
      },
      stream() {
        return Jo;
      },
...
var es = [
  ...
  ja({
    ...
    parse: {
      sync(e, t) {
        return { factory: t.parse(Jo), stream: t.parse(Ki()) };
      },
      async async(e, t) {
        return { factory: await t.parse(Jo), stream: await t.parse($o(e)[0]) };
      },
      stream(e, t) {
        let [n, r] = $o(e);
        return (t.addCleanup(r), { factory: t.parse(Jo), stream: t.parse(n) });
      },
    },
    serialize(e, t) {
      return `(` + t.serialize(e.factory) + `)(` + t.serialize(e.stream) + `)`;
    ...
    deserialize(e, t) {
      return Yo(t.deserialize(e.stream));
    },
  }),
];
function ts() {
  return [...(fe()?.serializationAdapters?.map(jo) ?? []), ...es];
}
var ns = new TextDecoder(),
  rs = new Uint8Array(),
  is = 16 * 1024 * 1024,
  as = 32 * 1024 * 1024,
  os = 1024,
...
function cs(e) {
  ...
  function l(e) {
    ...
    if (n.size >= os)
      throw Error(`Too many raw streams in framed response (max ${os})`);
    ...
    (async () => {
      ...
      try {
        for (;;) {
          ...
          if (a) {
            if (l + a.length > as)
              throw Error(`Framed response buffer exceeded ${as} bytes`);
            for (c.push(a), l += a.length; ;) {
              ...
              if (a > is)
                throw Error(`Frame payload too large: ${a} bytes (max ${is})`);
              let c = 9 + a;
              if (l < c) break;
              if (++o > ss)
                throw Error(`Too many frames in framed response (max ${ss})`);
              f(9);
              let p = f(a);
              switch (n) {
                case ue.JSON:
                  try {
                    s.enqueue(ns.decode(p));
                  } catch {}
                  break;
                case ue.CHUNK: {
                  let e = u(i);
...
function fs(e) {
  for (let t in e) if (ds.call(e, t)) return !0;
  return !1;
}
async function ps(e, t, n) {
  ...
  if (
    ...
    a === `payload` &&
      o.set(`accept`, `${le}, application/x-ndjson, application/json`),
    r.method === `GET`)
  ) {
    if (a === `formData`)
...
async function ms(e) {
  ...
  if (
    ...
    e.context && fs(e.context) && ((t = !0), (n.context = e.context)),
    t)
  )
    return hs(n);
}
async function hs(e) {
  return JSON.stringify(await Promise.resolve(ko(e, { plugins: ls })));
}
async function gs(e) {
  if (e.data instanceof FormData) {
    let t;
    return (
      e.context && fs(e.context) && (t = await hs(e.context)),
      t !== void 0 && e.data.set(se, t),
      { body: e.data }
    );
  }
  let t = await ms(e);
...
async function _s(e) {
  ...
  if ((n || ze(), t.headers.get(`x-tss-serialized`))) {
    let e;
    if (n.includes(`application/x-tss-framed`)) {
      if ((T(n), !t.body)) throw Error(`No response body for framed response`);
      let { getOrCreateStream: r, jsonChunks: i } = cs(t.body),
        a = [Ko(r), ...(ls || [])],
        o = new Map();
      e = await vs({
        jsonStream: i,
        onMessage: (e) => Oo(e, { refs: o, plugins: a }),
        onError(e, t) {
          console.error(e, t);
        },
      });
    ...
    if ((e || ze(), e instanceof Error)) throw e;
    return e;
  }
...
async function vs({ jsonStream: e, onMessage: t, onError: n }) {
  let r = e.getReader(),
...
function ys(e) {
  ...
  return Object.assign(
    (...e) => {
      let n = fe()?.serverFns?.fetch;
      return ps(t, e, n ?? fetch);
    },
    { url: t, serverFnMeta: { id: e }, [ce]: !0 },
  );
}
var bs = Ao({
  key: `$TSS/serverfn`,
  test: (e) => (typeof e != `function` || !(ce in e) ? !1 : !!e[ce]),
  toSerializable: ({ serverFnMeta: e }) => ({ functionId: e.id }),
  fromSerializable: ({ functionId: e }) => ys(e),
});
function xs(e) {
...
async function Cs(e) {
  ...
  ((window.$_TSR.initialized = !0), window.$_TSR.router || ze());
  let n = window.$_TSR.router;
  (n.matches.forEach((e) => {
    e.i = xs(e.i);
  }),
    (n.lastMatchId &&= xs(n.lastMatchId)));
...
var z = e(r(), 1),
  ws = z.use,
  Ts = typeof window < `u` ? z.useLayoutEffect : z.useEffect;
function Es(e) {
...
function ks({ promise: e }) {
  if (ws) return ws(e);
  let t = qn(e);
  if (t[Kn].status === `pending`) throw t;
  if (t[Kn].status === `error`) throw t[Kn].error;
  return t[Kn].data;
}
function As(e) {
  let t = (0, B.jsx)(js, { ...e });
...
var Ns = class extends z.Component {
  constructor(...e) {
...
function Fs({ children: e, fallback: t = null }) {
  return Is()
...
var Hs = [],
  Us = 0,
  {
    ...
    notify(e) {
      ((Hs[Xs++] = e), (e.flags &= ~V.Watching));
    },
    unwatched(e) {
      e.depsTail !== void 0 &&
        ((e.depsTail = void 0), (e.flags = V.Mutable | V.Dirty), ec(e));
    },
  }),
  Ys = 0,
  Xs = 0,
    ...
    i = {
      ...
      _update(e) {
        ...
        try {
          ...
          ((Zs = a), n && (i.flags &= ~V.RecursedCheck), ec(i));
        }
      },
    };
  return (
    n
      ? ((i.flags = V.Mutable | V.Dirty),
        (i.get = function () {
          let e = i.flags;
          if (e & V.Dirty || (e & V.Pending && qs(i.deps, i))) {
            if (i._update()) {
              let e = i.subs;
              e !== void 0 && Js(e);
            }
...
function rc(e) {
  let t = () => {
      ...
      try {
        ...
        ((Zs = t), (n.flags &= ~V.RecursedCheck), ec(n));
      }
    },
    n = {
      deps: void 0,
      ...
      notify() {
        let e = this.flags;
        e & V.Dirty || (e & V.Pending && qs(this.deps, this))
          ? t()
          : (this.flags = V.Watching);
      },
      stop() {
        ((this.flags = V.None), (this.depsTail = void 0), ec(this));
      },
    };
  return (t(), n);
}
...
function uc(e, t) {
  ...
  return (r) => {
    ...
    return (e?.structuralSharing ?? t.options.defaultStructuralSharing)
      ? (n.current = ye(n.current, i))
      : i;
  };
}
function dc(e) {
  let t = n(),
    r = z.useContext(e.from ? zs : Rs),
    i = e.from
...
function pc(e) {
  let { select: t, ...n } = e;
  return dc({ ...n, select: (e) => (t ? t(e.loaderDeps) : e.loaderDeps) });
}
function mc(e) {
  return dc({
    from: e.from,
...
function vc(e, t) {
  let r = n(),
    ...
    D = z.useMemo(() => {
      let e = { _fromLocation: E, ...me };
      return r.buildLocation(e);
    }, [r, E, me]),
    ge = D.maskedLocation ? D.maskedLocation.publicHref : D.publicHref,
    _e = D.maskedLocation ? D.maskedLocation.external : D.external,
    ve = z.useMemo(() => Dc(ge, _e, r.history, y), [y, _e, ge, r.history]),
    ye = z.useMemo(() => {
      if (ve?.external)
        return Me(ve.href, r.protocolAllowlist) ? void 0 : ve.href;
      if (!Oc(c) && !(typeof c != `string` || c.indexOf(`:`) === -1))
        try {
          return (new URL(c), Me(c, r.protocolAllowlist) ? void 0 : c);
        } catch {}
    }, [c, ve, r.protocolAllowlist]),
    be = z.useMemo(() => {
      if (ye) return !1;
      if (s?.exact) {
        if (!_t(E.pathname, D.pathname, r.basepath)) return !1;
      } else {
        let e = gt(E.pathname, r.basepath),
          t = gt(D.pathname, r.basepath);
        if (!(
          e.startsWith(t) &&
      ...
      return (s?.includeSearch ?? !0) &&
        !we(E.search, D.search, {
          partial: !s?.exact,
          ignoreUndefined: !s?.explicitUndefined,
        })
        ? !1
        : !s?.includeHash || (pe && E.hash === D.hash);
    }, [
      s?.exact,
      s?.explicitUndefined,
      s?.includeHash,
    ...
    Te = (b || xe.style || Se.style) && { ...b, ...xe.style, ...Se.style },
    [Ee, De] = z.useState(!1),
    Oe = z.useRef(!1),
    ke = e.reloadDocument || ye ? !1 : (l ?? r.options.defaultPreload),
    Ae = u ?? r.options.defaultPreloadDelay ?? 0,
    je = z.useCallback(() => {
      r.preloadRoute({ ...me, _builtLocation: D }).catch((e) => {
        (console.warn(e), console.warn(Jn));
      });
    }, [r, me, D]);
  (Ds(
    i,
    ...
    Tc,
    { disabled: !!y || ke !== `viewport` },
  ),
    z.useEffect(() => {
      Oe.current || (!y && ke === `render` && (je(), (Oe.current = !0)));
    }, [y, je, ke]));
  let Ne = (e) => {
  ...
  return {
    ...
    onBlur: Ec([C, Ie]),
    onFocus: Ec([ee, Pe]),
    onMouseEnter: Ec([te, Pe]),
    onMouseLeave: Ec([ne, Ie]),
    onTouchStart: Ec([re, Fe]),
    disabled: !!y,
    target: v,
    ...(Te && { style: Te }),
    ...(Ce && { className: Ce }),
...
var yc = {},
  bc = { className: `active` },
  xc = { role: `link`, "aria-disabled": !0 },
  Sc = { "data-status": `active`, "aria-current": `page` },
...
var jc = class extends tr {
  constructor(e) {
    (super(e),
      ...
      (this.useRouteContext = (e) => gc({ ...e, from: this.id })),
      (this.useSearch = (e) =>
        hc({
          select: e?.select,
          structuralSharing: e?.structuralSharing,
      ...
      (this.useLoaderData = (e) => fc({ ...e, from: this.id })),
      (this.useNavigate = () => i({ from: this.fullPath })),
      (this.Link = z.forwardRef((e, t) =>
        (0, B.jsx)(kc, { ref: t, from: this.fullPath, ...e }),
      )));
  }
};
function Mc(e) {
...
function Ic(e) {
  return new Lc(e, { silent: !0 }).createRoute;
}
var Lc = class {
  constructor(e, t) {
    ((this.path = e),
...
function U(e) {
  let t = n(),
    r = `not-found-${H(t.stores.location, (e) => e.pathname)}-${H(t.stores.status, (e) => e)}`;
  return (0, B.jsx)(Ms, {
    getResetKey: () => r,
    onCatch: (t, n) => {
...
var Hc = (e, t) =>
  ...
  Uc = (e, t) => e[0] === t[0] && e[1] === t[1],
  Wc = z.memo(function ({ matchId: e }) {
    let t = n(),
      r = t.stores.matchStores.get(e);
    r || ze();
    let i = H(t.stores.loadedAt, (e) => e),
      a = H(r, (e) => e, Hc);
    return (0, B.jsx)(Gc, {
      router: t,
      matchId: e,
...
function Gc({ router: e, matchId: t, resetKey: n, matchState: r }) {
  let i = e.routesById[r.routeId],
    ...
    f = s ? Ms : Bc,
    p = l ? U : Bc;
  return (0, B.jsxs)(i.isRoot ? (i.options.shellComponent ?? Bc) : Bc, {
    children: [
      (0, B.jsx)(Rs.Provider, {
        value: t,
        children: (0, B.jsx)(d, {
            ...
            children: (0, B.jsx)(p, {
              ...
              children:
                u || r._displayPending
                  ? (0, B.jsx)(Fs, {
                      fallback: o,
                      children: (0, B.jsx)(qc, { matchId: t }),
                    })
                  : (0, B.jsx)(qc, { matchId: t }),
            }),
          }),
        }),
      }),
      r.parentRouteId === `__root__`
        ? (0, B.jsxs)(B.Fragment, {
            children: [(0, B.jsx)(Kc, {}), (e.options.scrollRestoration, null)],
          })
        : null,
    ],
  });
...
function Kc() {
  ...
  return (
    Ts(() => {
      ...
      (n &&
        (!r || r.href !== n.href) &&
        e.emit({ type: `onRendered`, ...Fn(e.stores.location.get(), r ?? n) }),
        (t.current = n));
    }, [H(e.stores.resolvedLocation, (e) => e?.state.__TSR_key), e]),
    null
  );
}
var qc = z.memo(function ({ matchId: e }) {
    let t = n(),
      r = (e, n) => t.getMatch(e.id)?._nonReactive[n] ?? e._nonReactive[n],
    ...
    let a = H(i, (e) => e),
      ...
      l = z.useMemo(() => {
        ...
        return e ? (0, B.jsx)(e, {}, c) : (0, B.jsx)(Jc, {});
    ...
    if (a.status === `notFound`)
      return (Ct(a.error) || ze(), Vc(t, s, a.error));
    if (a.status === `redirected`)
      throw (qt(a.error) || ze(), r(a, `loadPromise`));
  ...
  Jc = z.memo(function () {
    let e = n(),
      ...
      a;
    {
      let n = t ? e.stores.matchStores.get(t) : void 0;
      (([r, i] = H(n, (e) => [e?.routeId, e?.globalNotFound ?? !1], Uc)),
        (a = H(e.stores.matchesId, (e) => e[e.findIndex((e) => e === t) + 1])));
    }
    let o = r ? e.routesById[r] : void 0,
      s = e.options.defaultPendingComponent
        ? (0, B.jsx)(e.options.defaultPendingComponent, {})
        : null;
    if (i) return (o || ze(), Vc(e, o, void 0));
    if (!a) return null;
    let c = (0, B.jsx)(Wc, { matchId: a });
    return r === `__root__`
      ? (0, B.jsx)(z.Suspense, { fallback: s, children: c })
      : c;
  });
function Yc() {
  let e = n(),
    ...
    [r, i] = z.useState(!1),
    a = H(e.stores.isLoading, (e) => e),
    o = H(e.stores.hasPending, (e) => e),
    s = Es(a),
    c = a || r || o,
    l = Es(c),
    u = a || o,
  ...
  return (
    ...
    z.useEffect(() => {
      ...
      return (
        mt(e.latestLocation.publicHref) !== mt(n.publicHref) &&
    ...
    Ts(() => {
      s &&
        ...
        e.emit({
          type: `onLoad`,
          ...Fn(e.stores.location.get(), e.stores.resolvedLocation.get()),
        });
    }, [s, e, a]),
    Ts(() => {
      d &&
    ...
    Ts(() => {
      if (l && !c) {
        let t = Fn(e.stores.location.get(), e.stores.resolvedLocation.get());
...
function Xc() {
  let e = n(),
    ...
    r = t ? (0, B.jsx)(t, {}) : null,
    i = (0, B.jsxs)(typeof document < `u` && e.ssr ? Bc : z.Suspense, {
      fallback: r,
      children: [(0, B.jsx)(Yc, {}), (0, B.jsx)(Zc, {})],
    });
  return e.options.InnerWrap
    ? (0, B.jsx)(e.options.InnerWrap, { children: i })
    : i;
}
function Zc() {
  let e = n(),
    t = H(e.stores.firstId, (e) => e),
    r = H(e.stores.loadedAt, (e) => e),
    i = t ? (0, B.jsx)(Wc, { matchId: t }) : null;
  return (0, B.jsx)(Rs.Provider, {
    value: t,
...
var Qc = (e) => ({
    createMutableStore: nc,
    createReadonlyStore: nc,
    batch: $s,
  }),
  $c = (e) => new el(e),
  el = class extends In {
...
function tl({ router: e, children: t, ...n }) {
  ge(n) &&
    e.update({
      ...e.options,
      ...n,
  ...
  let r = (0, B.jsx)(a.Provider, { value: e, children: t });
  return e.options.Wrap ? (0, B.jsx)(e.options.Wrap, { children: r }) : r;
}
function nl({ router: e, ...t }) {
  return (0, B.jsx)(tl, { router: e, ...t, children: (0, B.jsx)(Xc, {}) });
}
function rl(e, t) {
  if (t)
...
function il(e) {
  ...
  switch (e.tag) {
    ...
    case `script`:
      return (0, B.jsx)(al, { attrs: t, preventScriptHoist: i, children: n });
    default:
      return null;
  }
}
function al({ attrs: e, children: t, preventScriptHoist: r }) {
  n();
  let i = Is(),
    a =
    ...
    (z.useEffect(() => {
      if (!a) {
        if (e?.src) {
          ...
          return (rl(n, e), document.head.appendChild(n), () => n.remove());
        }
        if (typeof t == `string`) {
  ...
  let t = n(),
    ...
    a = z.useMemo(() => {
      ...
      return (
        n && e.push(n),
        r &&
          e.push({ tag: `meta`, attrs: { property: `csp-nonce`, content: r } }),
        e.reverse(),
        e
      );
    }, [i, r]),
              ...
              i.routes[t.routeId]?.css?.forEach((t) => {
                ...
                a.push({
                  ...
                  attrs: {
                    rel: `stylesheet`,
                    ...n,
                    crossOrigin: Yn(e, `stylesheet`) ?? n.crossOrigin,
                    suppressHydrationWarning: !0,
                    nonce: r,
                  },
                });
          ...
          a &&
            n.forEach((t) => {
              a.routes[t.routeId]?.preloads?.forEach((t) => {
                i.push({ tag: `link`, attrs: { ...Zn(a, t, e), nonce: r } });
              });
            }),
          i
        );
...
function sl(e) {
  let t = ol(e.assetCrossOrigin),
    r = n().options.ssr?.nonce;
  return (0, B.jsx)(B.Fragment, {
    children: t.map((e) =>
      (0, z.createElement)(il, {
        ...e,
...
var cl = () => {
  let e = n(),
    ...
    a = H(e.stores.matches, r, we);
  return W(e, H(e.stores.matches, i, we), a);
};
function W(e, t, n) {
  let r = [...t, ...n];
  return (0, B.jsx)(B.Fragment, {
    children: r.map((e, t) =>
      (0, z.createElement)(il, { ...e, key: `tsr-scripts-${e.tag}-${t}` }),
    ),
  });
}
var ll = (e, t) => {
...
var yl = class extends S {
    ...
    find(e) {
      let t = { exact: !0, ...e };
      return this.getAll().find((e) => l(t, e));
    }
    findAll(e = {}) {
      let t = this.getAll();
      return Object.keys(e).length > 0 ? t.filter((t) => l(e, t)) : t;
    }
    notify(e) {
      d.batch(() => {
        this.listeners.forEach((t) => {
  ...
  bl = class {
    ...
    ensureQueryData(e) {
      ...
      return r === void 0
        ? this.fetchQuery(e)
        : (e.revalidateIfStale &&
            n.isStaleByTime(te(t.staleTime, n)) &&
    ...
    async query(e) {
      ...
      let n = this.#e.build(this, t),
        r = n.isStaleByTime(te(t.staleTime, n))
          ? await n.fetch(t)
          : n.state.data,
        i = t.select;
      return i ? i(r) : r;
    ...
    fetchQuery(e) {
      ...
      t.retry === void 0 && (t.retry = !1);
      let n = this.#e.build(this, t);
      return n.isStaleByTime(te(t.staleTime, n))
        ? n.fetch(t)
    ...
    setQueryDefaults(e, t) {
      this.#r.set(v(e), { queryKey: e, defaultOptions: t });
    }
    getQueryDefaults(e) {
      let t = [...this.#r.values()],
        n = {};
    ...
    setMutationDefaults(e, t) {
      this.#i.set(v(e), { mutationKey: e, defaultOptions: t });
    }
...
function Dl() {
  return (wl() ? window.vam : Tl()) || `production`;
}
function Ol() {
  return Dl() === `development`;
}
function kl(e) {
  return e.scriptSrc
    ? jl(e.scriptSrc)
    : Ol()
      ...
      : e.basePath
        ? jl(`${e.basePath}/insights/script.js`)
...
function Al(e, t) {
  ...
  El(n.mode);
  let r = { sdkn: Sl + (n.framework ? `/${n.framework}` : ``), sdkv: Cl };
  return (
    n.disableAutoTrack && (r.disableAutoTrack = `1`),
    n.viewEndpoint && (r.viewEndpoint = jl(n.viewEndpoint)),
    n.eventEndpoint && (r.eventEndpoint = jl(n.eventEndpoint)),
    n.sessionEndpoint && (r.sessionEndpoint = jl(n.sessionEndpoint)),
    Ol() && n.debug === !1 && (r.debug = `false`),
    n.dsn && (r.dsn = n.dsn),
    n.endpoint
      ? (r.endpoint = n.endpoint)
      : n.basePath && (r.endpoint = jl(`${n.basePath}/insights`)),
    { beforeSend: n.beforeSend, src: kl(n), dataset: r }
  );
}
function jl(e) {
...
function Ml(e = { debug: !0 }, t) {
  var n;
  if (!wl()) return;
  let { beforeSend: r, src: i, dataset: a } = Al(e, t);
  if (
    (xl(),
...
function Il(e) {
  return (
    ...
    (0, z.useEffect)(() => {
      e.route && e.path && Nl({ route: e.route, path: e.path });
    }, [e.route, e.path]),
    null
  );
}
  ...
  return e.scriptSrc
    ...
    : q()
      ...
      : e.dsn
        ...
        : e.basePath
          ? Bl(`${e.basePath}/speed-insights/script.js`)
...
function Y(e, t) {
  ...
  let r = { sdkn: Rl + (n.framework ? `/${n.framework}` : ``), sdkv: zl };
  return (
    n.sampleRate && (r.sampleRate = n.sampleRate.toString()),
    n.route && (r.route = n.route),
    q() && n.debug === !1 && (r.debug = `false`),
    n.dsn && (r.dsn = n.dsn),
    n.endpoint
      ? (r.endpoint = Bl(n.endpoint))
      : n.basePath && (r.endpoint = Bl(`${n.basePath}/speed-insights/vitals`)),
    { src: J(n), beforeSend: n.beforeSend, dataset: r }
  );
}
function Bl(e) {
  return e.startsWith(`http://`) ||
...
function Vl(e = {}, t) {
  var n;
  if (!G() || e.route === null) return null;
  Ll();
  let { beforeSend: r, src: i, dataset: a } = Y(e, t);
...
var X = `/assets/styles-C78guQWu.css`,
  Gl = `/assets/glanzy-BQn1tsic.css`;
function Kl(e, t = {}) {
...
function Yl({ error: e, reset: t }) {
  ...
  return (
    (0, z.useEffect)(() => {
      Kl(e, { boundary: `tanstack_root_error_component` });
    }, [e]),
    (0, B.jsx)(`div`, {
      className: `flex min-h-screen items-center justify-center bg-background px-4`,
      children: (0, B.jsxs)(`div`, {
...
function Zl({ children: e }) {
  return (0, B.jsxs)(`html`, {
    ...
    suppressHydrationWarning: !0,
    children: [
      (0, B.jsx)(`head`, { children: (0, B.jsx)(sl, {}) }),
      (0, B.jsxs)(`body`, {
        suppressHydrationWarning: !0,
        children: [e, (0, B.jsx)(cl, {})],
      }),
    ],
  });
}
function Ql() {
  let { queryClient: e } = Xl.useRouteContext();
  return (0, B.jsxs)(c, {
    client: e,
    children: [
      (0, B.jsx)(Jc, {}),
      (0, B.jsx)(ql, { position: `bottom-right`, richColors: !0 }),
      (0, B.jsx)(Il, {}),
      (0, B.jsx)(Wl, {}),
    ],
  });
...
var $l = `modulepreload`,
  ...
  nu = function (e, t, n) {
    ...
    if (t && t.length > 0) {
      ...
      r = o(
        t.map((t) => {
          if (((t = eu(t, n)), (t = s(t)), t in tu)) return;
          tu[t] = !0;
  ...
  iu = Ic(`/auth`)({
    ...
    component: Rc(
      () =>
        nu(() => import(`./auth-BbZdy2oX.js`), __vite__mapDeps([5, 1, 2, 4])),
      `component`,
    ),
  }),
  au = {
    IndexRoute: ru.update({ id: `/`, path: `/`, getParentRoute: () => Xl }),
    AuthRoute: iu.update({
      id: `/auth`,
      path: `/auth`,
      getParentRoute: () => Xl,
  ...
  ou = Xl._addFileChildren(au),
  su = () =>
    $c({
      routeTree: ou,
      context: { queryClient: new bl() },
      scrollRestoration: !0,
...
function fu() {
  return (
    ...
    (0, B.jsx)(As, {
      promise: du,
      children: (e) => (0, B.jsx)(nl, { router: e }),
    })
  );
}
var pu = oe();
(0, z.startTransition)(() => {
  (0, pu.hydrateRoot)(
    document,
    (0, B.jsx)(z.StrictMode, { children: (0, B.jsx)(fu, {}) }),
  );
});
