...
import { r as o, t as s, x as c } from "./index-Difz8PWa.js";
import { a as l, i as u, n as d, r as f, t as p } from "./phone-CA_HO8J9.js";
import { t as m } from "./supabase-DTorYgRt.js";
import { t as h } from "./useMonetization-C0l42Clg.js";
import { t as g } from "./createLucideIcon-CEGepnBf.js";
import { t as _ } from "./arrow-right-D5pQCwSL.js";
import { t as v } from "./calendar-DJ3ZQlXp.js";
import { t as y } from "./check-CCy2ox4b.js";
import { t as b } from "./mail-DUe2Erw0.js";
import { t as x } from "./save-DWdmpGqL.js";
import { t as S } from "./search-B10CUpjR.js";
import { t as C } from "./send-C1wOFq8M.js";
import { t as w } from "./user-dmWph8jC.js";
import { t as T } from "./x-_CKTk_uH.js";
var E = g(`briefcase`, [
  ...
  N = e(t(), 1),
  P = n(),
  F = [`Saved`, `Contacted`, `Replied`, `Interested`, `Meeting`, `Won`, `Lost`],
  I = (e) => {
    switch (e) {
      case `Won`:
...
function L({ userId: e, defaultSelectedId: t }) {
  let n = c(),
    [s, f] = (0, N.useState)(`pipeline`),
    ...
    [F, L] = (0, N.useState)(``);
  (0, N.useEffect)(() => {
    let e = setTimeout(() => L(y.trim()), 400);
    return () => clearTimeout(e);
  }, [y]);
  let { workspaceId: z } = h(e),
    B = i({
      queryKey: [`contacted`, z],
      enabled: !!z,
      queryFn: async () => {
        let { data: e, error: t } = await m
          .from(`outreach`)
          .select(`*, brand:brand_id (${l})`)
          .eq(`workspace_id`, z)
    ...
    V = (0, N.useMemo)(() => B.data || [], [B.data]),
    H = (0, N.useMemo)(
      () =>
        V.filter((e) => {
          if (w.length > 0 && !w.includes(e.status)) return !1;
          if (F) {
            let t = F.toLowerCase(),
              n = e.brand;
            if (
              ...
              (!n.company_name.toLowerCase().includes(t) &&
                !n.industry?.toLowerCase().includes(t) &&
                !n.contact_person?.toLowerCase().includes(t) &&
    ...
    U = a({
      mutationFn: async (t) => {
        if (!z) throw Error(`No workspace`);
        let { data: n, error: r } = await m
          .from(`outreach`)
          .select(`id`)
          .eq(`workspace_id`, z)
          .eq(`brand_id`, t)
      ...
      onSuccess: (e) => {
        (n.invalidateQueries({ queryKey: [`contacted`] }),
          g(e),
  ...
  (0, N.useEffect)(() => {
    if (t && z && B.isSuccess) {
      let e = V.find((e) => e.brand_id === t);
      e
        ? (g(e.id), window.history.replaceState({}, ``, `/contacted`))
        : !U.isPending && !U.isSuccess && U.mutate(t);
    }
  }, [t, z, B.isSuccess, V, U]);
  let W = a({
      mutationFn: async ({ id: t, status: n, oldStatus: r }) => {
        let { error: i } = await m
          .from(`outreach`)
      ...
      onSuccess: () => {
        (o.success(`Status updated`),
          n.invalidateQueries({ queryKey: [`contacted`] }),
          n.invalidateQueries({ queryKey: [`contacted_activity`, p] }));
      },
      onError: (e) => o.error(e.message || `Could not update status`),
    }),
    G = a({
      mutationFn: async ({ id: t, oldStatus: n }) => {
      ...
      onSuccess: () => {
        (o.success(`Marked as contacted!`),
          n.invalidateQueries({ queryKey: [`contacted`] }),
          n.invalidateQueries({ queryKey: [`contacted_activity`, p] }));
      },
      onError: (e) => o.error(e.message || `Error updating`),
    }),
    K = a({
      mutationFn: async ({ id: t, subject: n, body: r }) => {
      ...
      onSuccess: () => {
        (o.success(`Draft saved successfully`),
          n.invalidateQueries({ queryKey: [`contacted`] }),
          n.invalidateQueries({ queryKey: [`contacted_activity`, p] }));
      },
      onError: (e) => o.error(e.message || `Could not save draft`),
    }),
    q = a({
      mutationFn: async ({ id: t, notes: n }) => {
        let r = new Date().toISOString(),
          { error: i } = await m
            .from(`outreach`)
            .update({ notes: n, updated_at: r, last_activity_at: r })
            .eq(`id`, t);
        if (i) throw i;
        await m
          .from(`outreach_activity`)
      ...
      onSuccess: () => {
        (o.success(`Notes saved`),
          n.invalidateQueries({ queryKey: [`contacted`] }),
          n.invalidateQueries({ queryKey: [`contacted_activity`, p] }));
      },
      onError: (e) => o.error(e.message || `Could not save notes`),
    }),
    J = a({
      mutationFn: async ({ id: e, next_action: t }) => {
        let n = new Date().toISOString(),
          { error: r } = await m
            .from(`outreach`)
            .update({ next_action: t, updated_at: n, last_activity_at: n })
            .eq(`id`, e);
        if (r) throw r;
      },
      onSuccess: () => {
        (o.success(`Next action updated`),
          n.invalidateQueries({ queryKey: [`contacted`] }));
      },
      onError: (e) => o.error(e.message || `Could not save next action`),
    }),
    Y = {
      active: V.filter((e) => ![`Won`, `Lost`].includes(e.status)).length,
      replied: V.filter((e) => e.status === `Replied`).length,
      meetings: V.filter((e) => e.status === `Meeting`).length,
      won: V.filter((e) => e.status === `Won`).length,
    },
    X = (p && H.find((e) => e.id === p)) || null;
  return (0, P.jsxs)(`div`, {
    ...
    children: [
            ...
            children: [
              ...
              (0, P.jsxs)(`div`, {
                ...
                children: [
                  (0, P.jsxs)(`button`, {
                    onClick: () => f(`pipeline`),
                    className: `flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-colors ${s === `pipeline` ? `bg-muted text-foreground shadow-sm` : `text-muted-foreground hover:text-foreground hover:bg-muted/50`}`,
                    children: [(0, P.jsx)(A, { size: 16 }), ` Pipeline`],
                  }),
                  (0, P.jsxs)(`button`, {
                    onClick: () => f(`list`),
                    className: `flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-colors ${s === `list` ? `bg-muted text-foreground shadow-sm` : `text-muted-foreground hover:text-foreground hover:bg-muted/50`}`,
                    children: [(0, P.jsx)(j, { size: 16 }), ` List`],
                  }),
                ],
              }),
            ],
      ...
      B.isLoading
        ? (0, P.jsxs)(`div`, {
            ...
            children: [
              (0, P.jsx)(`div`, {
                className: `h-8 w-8 animate-spin rounded-full border-4 border-brand border-t-transparent mb-4`,
              }),
              (0, P.jsx)(`p`, {
          ...
          ? (0, P.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, P.jsxs)(r, {
                  ...
                  children: [(0, P.jsx)(d, { size: 18 }), ` Discover Brands`],
                }),
              ],
            })
          : (0, P.jsxs)(`div`, {
                    ...
                    children: [
                      (0, P.jsxs)(`div`, {
                        ...
                        children: [
                          (0, P.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, P.jsxs)(`p`, {
                                ...
                                children: [H.length, ` opportunities`],
                              }),
                            ],
                          }),
                          (0, P.jsx)(`div`, {
                          ...
                          ${t ? `bg-brand/5 border-brand/30 shadow-sm` : `bg-transparent border-transparent hover:bg-muted/50 hover:border-border/50`}
                        `,
                                  children: [
                                    (0, P.jsxs)(`div`, {
                                      ...
                                      children: [
                                        ...
                                        (0, P.jsx)(`span`, {
                                          className: `text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full whitespace-nowrap border ${I(e.status)}`,
                                          children: e.status,
                                        }),
                                      ],
                                    }),
                      ...
                      (0, P.jsx)(`div`, {
                        ...
                        children: X
                          ? (0, P.jsx)(R, {
                              ...
                              onMarkContacted: () =>
                                G.mutate({ id: X.id, oldStatus: X.status }),
                              onSaveEmail: (e, t) =>
                                K.mutate({ id: X.id, subject: e, body: t }),
                              onSaveNotes: (e) =>
                                q.mutate({ id: X.id, notes: e }),
                              onSaveNextAction: (e) =>
                                J.mutate({ id: X.id, next_action: e }),
                            })
                          : (0, P.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, P.jsx)(`p`, {
                                  ...
                                  children: `Choose a brand from the list to view details and manage contacted.`,
                                }),
                              ],
                            }),
                      }),
                  ...
                  (0, P.jsx)(`div`, {
                    ...
                    children: (0, P.jsx)(`div`, {
                      ...
                      children: (0, P.jsx)(R, {
                        ...
                        onSaveEmail: (e, t) =>
                          K.mutate({ id: X.id, subject: e, body: t }),
                        onSaveNotes: (e) => q.mutate({ id: X.id, notes: e }),
                        onSaveNextAction: (e) =>
                          J.mutate({ id: X.id, next_action: e }),
                      }),
                    }),
...
function R({
  ...
  let [h, g] = (0, N.useState)(`details`),
    [v, S] = (0, N.useState)(e.email_subject || ``),
    [D, O] = (0, N.useState)(e.email_body || ``),
    [A, j] = (0, N.useState)(e.notes || ``),
    [L, R] = (0, N.useState)(e.next_action || ``);
  (0, N.useEffect)(() => {
    (S(e.email_subject || ``),
      O(e.email_body || ``),
      j(e.notes || ``),
      R(e.next_action || ``));
  }, [e.id, e.email_subject, e.email_body, e.notes, e.next_action]);
  let z = i({
    queryKey: [`contacted_activity`, e.id],
    queryFn: async () => {
      let { data: t, error: n } = await m
        .from(`outreach_activity`)
        .select(`*`)
        .eq(`contacted_id`, e.id)
  ...
  return (0, P.jsxs)(`div`, {
    ...
    children: [
                ...
                children: [
                  (0, P.jsxs)(`span`, {
                    ...
                    children: [
                      (0, P.jsx)(E, { size: 14 }),
                      ` `,
                      e.brand?.industry || `Industry unspecified`,
                    ],
                  }),
                  e.brand?.country &&
                    (0, P.jsxs)(`span`, {
              ...
              (0, P.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, P.jsx)(`select`, {
                    ...
                    className: `h-9 pl-3 pr-8 rounded-xl text-sm font-bold shadow-sm appearance-none cursor-pointer border focus:ring-2 focus:ring-brand focus:outline-none ${I(e.status)}`,
                    children: F.map((e) =>
                      (0, P.jsx)(`option`, { value: e, children: e }, e),
                    ),
                  }),
                ],
              }),
      ...
      (0, P.jsx)(`div`, {
        ...
        children: [
          { id: `details`, icon: k, label: `Details & Notes` },
          { id: `email`, icon: b, label: `Email Draft` },
          { id: `history`, icon: u, label: `Activity History` },
        ].map((e) =>
          (0, P.jsxs)(
            `button`,
            {
              onClick: () => g(e.id),
              className: `flex items-center gap-2 pb-3 px-1 text-sm font-semibold transition-all border-b-2 whitespace-nowrap ${h === e.id ? `border-brand text-brand` : `border-transparent text-muted-foreground hover:text-foreground hover:border-border`}`,
              children: [(0, P.jsx)(e.icon, { size: 16 }), ` `, e.label],
            },
            e.id,
          ),
        ),
        ...
        children: [
                                ...
                                (0, P.jsxs)(`div`, {
                                  children: [
                                    (0, P.jsx)(`p`, {
                                      ...
                                      children: e.brand.contact_person,
                                    }),
                                    e.brand.contact_role &&
                                      (0, P.jsx)(`p`, {
                                        className: `text-sm text-muted-foreground`,
                                        children: e.brand.contact_role,
                                      }),
                                  ],
                                }),
                                (0, P.jsxs)(`div`, {
                                    ...
                                    e.brand.email &&
                                      (0, P.jsxs)(`a`, {
                                        ...
                                        children: [
                                          ...
                                          (0, P.jsx)(`span`, {
                                            className: `truncate`,
                                            children: e.brand.email,
                                          }),
                                        ],
                                      }),
                                    e.brand.phone &&
                                      (0, P.jsxs)(`a`, {
                                        href: `tel:${e.brand.phone}`,
                                        className: `flex items-center gap-3 text-sm text-foreground hover:text-brand transition-colors p-2 rounded-lg hover:bg-muted/50 border border-transparent hover:border-border`,
                                        children: [
                                          (0, P.jsx)(`div`, {
                                            className: `w-8 h-8 rounded-full bg-brand/10 text-brand flex items-center justify-center shrink-0`,
                ...
                (0, P.jsxs)(`div`, {
                  ...
                  children: [
                    (0, P.jsxs)(`h3`, {
                      className: `text-sm font-bold text-foreground mb-4 flex items-center gap-2`,
                      children: [
                        (0, P.jsx)(M, { size: 16, className: `text-brand` }),
                        ` Workspace Notes`,
                      ],
                    }),
                    (0, P.jsx)(`p`, {
                    ...
                    (0, P.jsx)(`div`, {
                      ...
                      children: (0, P.jsxs)(`button`, {
                        ...
                        children: [(0, P.jsx)(x, { size: 14 }), ` Save Notes`],
                      }),
                    }),
                  ],
                }),
                ...
                (0, P.jsxs)(`div`, {
                  ...
                  children: [
                    (0, P.jsxs)(`h3`, {
                      ...
                      children: [
                        (0, P.jsx)(b, { size: 16, className: `text-brand` }),
                        ` Email Drafter`,
                      ],
                    }),
                    e.status === `Saved` &&
                  ...
                  children: [
                    ...
                    (0, P.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, P.jsxs)(`button`, {
                          onClick: () => s(v, D),
                          disabled: v === e.email_subject && D === e.email_body,
                        ...
                        (0, P.jsxs)(`a`, {
                          href: `mailto:${e.brand?.email || ``}?subject=${encodeURIComponent(v)}&body=${encodeURIComponent(D)}`,
          ...
          h === `history` &&
            (0, P.jsx)(`div`, {
              ...
              children: z.isLoading
                ? (0, P.jsx)(`div`, {
                    className: `flex justify-center p-8`,
                    children: (0, P.jsx)(`div`, {
                      className: `w-6 h-6 animate-spin rounded-full border-2 border-brand border-t-transparent`,
                    }),
                  })
                : z.data?.length === 0
                  ? (0, P.jsx)(`div`, {
                          ...
                          `div`,
                          {
                            ...
                            children: [
                              (0, P.jsx)(`div`, {
                                ...
                                children: (0, P.jsx)(`div`, {
                                  className: `w-2.5 h-2.5 rounded-full ${e.activity_type === `status_changed` ? `bg-brand` : e.activity_type === `contacted` ? `bg-green-500` : e.activity_type === `created` ? `bg-blue-500` : `bg-muted-foreground`}`,
                                }),
                              }),
                              (0, P.jsxs)(`div`, {
                                className: `pl-4`,
                                children: [
                                  ...
                                  (0, P.jsx)(`div`, {
                                    ...
                                    children:
                                      e.activity_type === `status_changed`
                                        ? (0, P.jsxs)(`p`, {
                                        ...
                                        : e.activity_type === `contacted`
                                          ? (0, P.jsx)(`p`, {
                                              className: `text-sm font-semibold text-foreground`,
                                              children: `Marked as Contacted`,
                                            })
                                          : e.activity_type === `created`
                                            ? (0, P.jsx)(`p`, {
                                                className: `text-sm font-semibold text-foreground`,
                                                children: `Contacted Started`,
                                              })
                                            : (0, P.jsx)(`p`, {
                                                className: `text-sm text-foreground`,
...
function z() {
  let [e, t] = (0, N.useState)(null),
    { brandId: n } = s.useSearch();
  return (
    (0, N.useEffect)(() => {
      m.auth.getSession().then(({ data: e }) => {
        e.session && t(e.session.user.id);
      });
    }, []),
    (0, P.jsx)(L, { userId: e, defaultSelectedId: n || null })
  );
}
