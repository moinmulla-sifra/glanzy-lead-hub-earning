...
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.for-you-B44pffZh.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function ForYouView({ userId }) {
  const queryClient = useQueryClient();
  const [selectedBrand, setSelectedBrand] = (0, import_react.useState)(null);
  const [savedBrandIds, setSavedBrandIds] = (0, import_react.useState)(
    /* @__PURE__ */ new Set(),
  );
  ...
  const isProfileIncomplete =
    ...
    !profileQuery.data?.primary_niche &&
    !profileQuery.data?.platforms?.length;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "flex flex-col h-full gap-6 lg:gap-8 pb-12 animate-in fade-in duration-500",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
            className:
              "text-3xl lg:text-4xl font-bold tracking-tight text-foreground flex items-center gap-3",
            children: [
      ...
      isLoading
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: [1, 2, 3, 4, 5, 6].map((i) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                ...
                {
                  className:
                    "bg-card rounded-3xl p-6 border border-border/50 shadow-sm animate-pulse h-64",
                },
                i,
              ),
            ),
        ...
        : isProfileIncomplete
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex-1 flex flex-col items-center justify-center text-center p-16 bg-card border border-border/60 rounded-3xl subtle-shadow",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "w-20 h-20 rounded-3xl bg-brand/10 flex items-center justify-center mb-6 border border-brand/20 shadow-sm",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                          to: "/profile",
                          className:
                            "px-6 py-3 bg-muted text-foreground rounded-xl text-sm font-semibold hover:bg-muted/80 transition-colors shadow-sm",
                          children: "Complete Profile",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                          to: "/discover",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          ...
                          children: recommendations.slice(0, 6).map((rec) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              RecommendationCard,
                              {
                                rec,
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
                            children: recommendations.slice(6, 12).map((rec) =>
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                RecommendationCard,
                                {
                                  rec,
...
function RecommendationCard({ rec, isSaved, onToggleSave, onClickView }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "bg-card rounded-3xl border border-border/60 overflow-hidden flex flex-col subtle-shadow hover:-translate-y-1 hover:shadow-xl hover:border-brand/30 transition-all duration-300",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "flex items-center gap-1 bg-brand/10 text-brand px-2.5 py-1 rounded-full text-xs font-bold border border-brand/20 shrink-0",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, {
                    className: "w-3 h-3",
                  }),
          ...
          reasons.length > 0 &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "mt-auto bg-muted/30 p-3 rounded-xl border border-border/50 space-y-2",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  className:
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
                  ...
                  children: reasons.slice(0, 2).map((reason, i) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "li",
                      {
                        className:
                          "flex items-start gap-1.5 text-foreground/80",
                        children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "p-4 border-t border-border/50 bg-muted/10 flex items-center gap-3",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            className:
              "flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-foreground text-background rounded-xl text-sm font-semibold hover:bg-foreground/90 transition-colors",
            children: "View Brand",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: (e) => {
...
function ForYouPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ForYouView, { userId });
}
//#endregion
