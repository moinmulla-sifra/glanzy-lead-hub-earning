...
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.team-DUGdb4lX.js
...
function TeamView({ userId }) {
	...
	const isAgency = (Array.isArray(workspaceMemberQuery.data?.workspaces) ? workspaceMemberQuery.data?.workspaces[0] : workspaceMemberQuery.data?.workspaces)?.workspace_type === "agency";
