...
import { t as useMonetization } from "./_ssr/useMonetization-B-HRUEIg.mjs";
import { y as Link } from "./_libs/@tanstack/react-router+[...].mjs";
import { t as require_jsx_dev_runtime } from "./_libs/react.mjs";
import { $ as Calendar, A as Mail, B as Globe, D as MessageSquare, F as LayoutGrid, J as CircleCheck, N as List, S as Phone, U as ExternalLink, V as FileText, Z as Check, b as Save, i as User, it as ArrowRight, n as X, ot as Activity, q as Clock, tt as Briefcase, v as Send, y as Search } from "./_libs/lucide-react.mjs";
import { t as Route } from "./_dashboard.contacted-DSaJgV6F.mjs";
import { t as BRAND_SELECT_FIELDS } from "./_ssr/constants-GxBJ0Kj6.mjs";
import { n as toast } from "./_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.contacted-DzFPVZn_.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var _jsxFileName$1 = "/app/applet/src/components/ContactedView.tsx";
var STATUSES = [
	"Saved",
	"Contacted",
	"Replied",
...
function ContactedView({ userId, defaultSelectedId }) {
	...
	const allRecords = (0, import_react.useMemo)(() => contactedQuery.data || [], [contactedQuery.data]);
	...
	const updateStatusMutation = useMutation({
		...
		onSuccess: () => {
			...
			queryClient.invalidateQueries({ queryKey: ["contacted"] });
			queryClient.invalidateQueries({ queryKey: ["contacted_activity", selectedId] });
		},
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
			...
			lineNumber: 379,
			columnNumber: 7
		}, this), contactedQuery.isLoading ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
			...
			children: [
				viewMode === "list" && /* @__PURE__ */ (void 0)("div", {
					...
					children: [/* @__PURE__ */ (void 0)("div", {
						...
						children: selected ? /* @__PURE__ */ (void 0)(ContactedDetailPane, {
							contacted: selected,
							userId,
				...
				viewMode === "pipeline" && selected && /* @__PURE__ */ (void 0)("div", {
					...
					children: /* @__PURE__ */ (void 0)("div", {
						...
						children: /* @__PURE__ */ (void 0)(ContactedDetailPane, {
							contacted: selected,
							userId,
							onClose: () => setSelectedId(null),
							onStatusChange: (status) => updateStatusMutation.mutate({
...
function ContactedDetailPane({ contacted, userId, onClose, onStatusChange, onMarkContacted, onSaveEmail, onSaveNotes, onSaveNextAction }) {
	const [activeTab, setActiveTab] = (0, import_react.useState)("details");
	const [emailSubject, setEmailSubject] = (0, import_react.useState)(contacted.email_subject || "");
	const [emailBody, setEmailBody] = (0, import_react.useState)(contacted.email_body || "");
	const [notes, setNotes] = (0, import_react.useState)(contacted.notes || "");
	const [nextAction, setNextAction] = (0, import_react.useState)(contacted.next_action || "");
	(0, import_react.useEffect)(() => {
	...
	const activityQuery = useQuery({
		...
		queryFn: async () => {
			const { data, error } = await supabase.from("outreach_activity").select("*").eq("contacted_id", contacted.id).order("created_at", { ascending: false });
			if (error) throw error;
			return data;
		}
	});
				...
				children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", {
							...
							lineNumber: 789,
							columnNumber: 13
						}, this), contacted.brand?.website && /* @__PURE__ */ (void 0)("a", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", {
							...
							lineNumber: 804,
							columnNumber: 13
						}, this), contacted.brand?.country && /* @__PURE__ */ (void 0)("span", {
							className: "flex items-center gap-1.5",
							children: [
						...
						children: [/* @__PURE__ */ (void 0)("div", {
							...
							children: [/* @__PURE__ */ (void 0)("div", {
								...
								children: [/* @__PURE__ */ (void 0)("h3", {
									...
									lineNumber: 874,
									columnNumber: 17
								}, this), contacted.brand?.contact_person ? /* @__PURE__ */ (void 0)("div", {
									className: "space-y-3",
									children: [/* @__PURE__ */ (void 0)("div", { children: [/* @__PURE__ */ (void 0)("p", {
										className: "font-bold text-foreground text-lg leading-none mb-1",
										children: contacted.brand.contact_person
									}, void 0, false, {
										fileName: _jsxFileName$1,
										lineNumber: 880,
										columnNumber: 23
									}, this), contacted.brand.contact_role && /* @__PURE__ */ (void 0)("p", {
										className: "text-sm text-muted-foreground",
										children: contacted.brand.contact_role
									}, void 0, false, {
										fileName: _jsxFileName$1,
										lineNumber: 884,
										columnNumber: 25
										...
										children: [contacted.brand.email && /* @__PURE__ */ (void 0)("a", {
											...
											lineNumber: 891,
											columnNumber: 25
										}, this), contacted.brand.phone && /* @__PURE__ */ (void 0)("a", {
											...
											children: [/* @__PURE__ */ (void 0)("div", {
												...
												lineNumber: 908,
												columnNumber: 27
											}, this), /* @__PURE__ */ (void 0)("span", { children: contacted.brand.phone }, void 0, false, {
												fileName: _jsxFileName$1,
												lineNumber: 911,
												columnNumber: 27
											}, this)]
						...
						children: [
							/* @__PURE__ */ (void 0)("div", {
								...
								children: [/* @__PURE__ */ (void 0)("h3", {
									...
									lineNumber: 982,
									columnNumber: 15
								}, this), contacted.status === "Saved" && /* @__PURE__ */ (void 0)("button", {
								...
								children: [/* @__PURE__ */ (void 0)("p", {
									...
									children: [
										...
										/* @__PURE__ */ (void 0)("button", {
											...
											disabled: emailSubject === contacted.email_subject && emailBody === contacted.email_body,
...
var _jsxFileName = "/app/applet/src/routes/_dashboard.contacted.tsx?tsr-split=component";
function ContactedPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ContactedView, {
		userId,
