...
//#endregion
//#region node_modules/.pnpm/@supabase+storage-js@2.115.0/node_modules/@supabase/storage-js/dist/index.mjs
function _typeof(o) {
...
var StorageFileApi = class extends BaseApiClient {
  ...
  download(path, options, parameters) {
    ...
    if (
      ...
      query.set("cacheNonce", String(options.cacheNonce));
    if (
      (options === null || options === void 0 ? void 0 : options.versionId) !=
      null
    )
