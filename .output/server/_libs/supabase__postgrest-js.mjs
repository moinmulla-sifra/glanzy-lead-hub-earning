//#region node_modules/.pnpm/@supabase+postgrest-js@2.115.0/node_modules/@supabase/postgrest-js/dist/index.mjs
/**
 * Error format
 *
  ...
  while (true) {
    ...
    if (shouldRetry(request.method, res.status, attemptCount, retryEnabled)) {
      ...
      const retryAfterHeader =
        (_res$headers$get =
          (_res$headers = res.headers) === null || _res$headers === void 0
            ? void 0
...
var PostgrestBuilder = class {
  ...
  then(onfulfilled, onrejected) {
    ...
    const executeWithRetry = async () => {
      ...
      const res$1 = await fetchWithRetry(
        _fetch,
        _this.url.toString(),
        {
          method: _this.method,
  ...
  async processResponse(res) {
    ...
    if (res.ok) {
      ...
      const contentRange =
        (_res$headers$get = res.headers.get("content-range")) === null ||
        _res$headers$get === void 0
          ? void 0
  ...
  try {
    ...
    if (parsed && typeof parsed === "object" && !Array.isArray(parsed)) {
      ...
      return new PostgrestError({
        message: String(
          (_parsed$message = parsed.message) !== null &&
            _parsed$message !== void 0
            ? _parsed$message
            : body,
        ),
        details:
          (_parsed$details = parsed.details) !== null &&
          _parsed$details !== void 0
            ? _parsed$details
            : "",
        hint:
          (_parsed$hint = parsed.hint) !== null && _parsed$hint !== void 0
            ? _parsed$hint
            : "",
        code:
          (_parsed$code = parsed.code) !== null && _parsed$code !== void 0
            ? _parsed$code
            : "",
      });
    }
...
var PostgrestClient = class PostgrestClient {
  ...
  async getOpenApiSpec() {
    ...
    const fetchImpl =
      (_this$fetch = _this.fetch) !== null && _this$fetch !== void 0
        ? _this$fetch
        : globalThis.fetch;
    let res;
    try {
      ...
      res = await fetchWithRetry(
        ...
        (_this$retry = _this.retry) !== null && _this$retry !== void 0
          ? _this$retry
          : true,
      );
    } catch (fetchError) {
