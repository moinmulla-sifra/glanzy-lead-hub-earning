...
import { N as LoaderCircle, _ as Shield, i as Users, o as UserPlus, s as UserMinus } from "./_libs/lucide-react.mjs";
import { n as toast } from "./_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.team-0pEI_FzW.js
...
function TeamView({ userId }) {
	...
	const workspaceMemberQuery = useQuery({
		...
		enabled: !!userId,
		queryFn: async () => {
			const { data, error } = await supabase.from("workspace_members").select("workspace_id, role, workspaces(name, type, workspace_type)").eq("user_id", userId).single();
	...
	const wsData = Array.isArray(workspaceMemberQuery.data?.workspaces) ? workspaceMemberQuery.data?.workspaces[0] : workspaceMemberQuery.data?.workspaces;
	const isAgency = wsData?.workspace_type === "agency" || wsData?.type === "agency";
			...
			children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", {
					...
					children: [
						...
						(Array.isArray(workspaceMemberQuery.data?.workspaces) ? workspaceMemberQuery.data?.workspaces[0] : workspaceMemberQuery.data?.workspaces)?.name,
						")."
					]
				}, void 0, true, {
					fileName: _jsxFileName$1,
