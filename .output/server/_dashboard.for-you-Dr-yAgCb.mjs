...
import { t as BrandProfileModal } from "./_ssr/BrandProfileModal-BI31Iv7h.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.for-you-Dr-yAgCb.js
...
function ForYouView({ userId }) {
	...
	const brandsQuery = useQuery({
		...
		queryFn: async () => {
			const { data, error } = await supabase.from("brands").select("*").limit(100).order("influencer_fit_score", {
				ascending: false,
				nullsFirst: false
			});
			if (error) throw error;
		...
		children: [
			...
			isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					5,
					6
				].map((i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "bg-card rounded-3xl p-6 border border-border/50 shadow-sm animate-pulse h-64" }, i))
			}) : isProfileIncomplete ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "w-10 h-10 text-brand" })
					}),
			...
			}) : brandsQuery.data?.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex-1 flex flex-col items-center justify-center text-center p-16 bg-card border border-border/60 rounded-3xl subtle-shadow",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
					...
					className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
					children: recommendations.slice(0, 6).map((rec) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RecommendationCard, {
						rec,
				...
				})] }), recommendations.length > 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
					className: "text-xl font-bold mb-4 flex items-center gap-2",
					...
					className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
					children: recommendations.slice(6, 12).map((rec) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RecommendationCard, {
						rec,
						isSaved: savedBrandIds.has(rec.brand.id),
						onToggleSave: () => toggleSaveMutation.mutate({
							brandId: rec.brand.id,
			...
			selectedBrand && workspaceId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrandProfileModal, {
				brand: selectedBrand,
				workspaceId,
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: "w-3 h-3" }),
							matchPercentage,
							"% Match"
						]
					})]
				...
				reasons.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: reasons.slice(0, 2).map((reason, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
