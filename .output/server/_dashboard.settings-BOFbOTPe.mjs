...
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.settings-BOFbOTPe.js
...
function SettingsView({ userId }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "flex flex-col lg:flex-row h-full gap-8 pb-12 animate-in fade-in duration-500 max-w-6xl mx-auto w-full",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
            className:
              "text-3xl font-bold tracking-tight text-foreground mb-4 px-2",
            children: "Settings",
          }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex-1 bg-card border border-border/60 rounded-3xl p-6 lg:p-10 subtle-shadow min-h-[500px]",
        children: [
          activeTab === "account" &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className:
                        "w-20 h-20 rounded-full bg-muted border border-border/50 flex items-center justify-center overflow-hidden shrink-0 shadow-sm",
                      children: profile?.avatar_url
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          ...
                          import_jsx_runtime.jsxs)("span", {
                            className:
                              "px-2.5 py-0.5 bg-muted rounded-md text-xs font-semibold capitalize border border-border/50",
                            children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "border-t border-border/50 pt-8 flex items-center justify-between",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          ...
                          children:
                            "Update your niche, connected platforms, and bio used for brand matching.",
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                      to: "/profile",
                      className:
                        "px-5 py-2.5 bg-foreground text-background font-semibold rounded-xl text-sm hover:bg-foreground/90 transition-colors shadow-sm",
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                          ...
                          className:
                            "w-full bg-background border border-border rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand/50 disabled:opacity-50",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className:
                            "bg-muted/30 p-4 rounded-xl border border-border/50",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                              className:
                                "text-xs text-muted-foreground font-semibold uppercase mb-1",
                              children: "Type",
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                    ...
                    isWorkspaceAdmin &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                        onClick: () =>
                          updateWorkspaceMutation.mutate(workspaceName),
                        disabled:
                          updateWorkspaceMutation.isPending ||
                          workspaceName === workspaceInfo?.name,
                        className:
                          "flex items-center gap-2 px-5 py-2.5 bg-brand text-brand-foreground font-semibold rounded-xl text-sm hover:bg-brand/90 transition-colors shadow-sm disabled:opacity-50",
                        children: [
                          updateWorkspaceMutation.isPending
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        disabled: true,
                        className:
                          "px-5 py-2.5 bg-muted text-muted-foreground font-semibold rounded-xl text-sm opacity-50 cursor-not-allowed",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        "input",
                        {
                          ...
                          className:
                            "w-full bg-background border border-border rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand/50",
                        },
                      ),
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      ...
                      className:
                        "flex items-center gap-2 px-5 py-2.5 bg-foreground text-background font-semibold rounded-xl text-sm hover:bg-foreground/90 transition-colors shadow-sm disabled:opacity-50",
                      children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      ...
                      className:
                        "flex items-center gap-2 px-5 py-2.5 bg-muted text-foreground font-semibold rounded-xl text-sm hover:bg-muted/80 transition-colors border border-border/50 shadow-sm",
                      children: [
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "flex items-center justify-between p-4 bg-muted/30 rounded-xl border border-border/50",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "w-10 h-6 bg-brand rounded-full relative opacity-50 cursor-not-allowed",
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "div",
                            {
                              className:
                                "w-4 h-4 bg-white rounded-full absolute right-1 top-1 shadow-sm",
                            },
                          ),
                        }),
                      ],
          ...
          activeTab === "about" &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
                          className:
                            "font-semibold mb-4 text-brand flex items-center gap-2",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              Sparkles,
                              { className: "w-4 h-4" },
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          ...
                          children:
                            "An AI-powered brand discovery and intelligence platform for creators and agencies.",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "bg-muted/20 border border-border/50 rounded-2xl p-6 shadow-sm",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                              ...
                              "div",
                              {
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    ...
                                    {
                                      className:
                                        "block text-muted-foreground text-xs uppercase mb-1",
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "a",
                                    {
                                      ...
                                      className:
                                        "text-foreground hover:text-brand font-medium",
          ...
          activeTab === "danger" &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "max-w-lg border border-destructive/20 bg-destructive/5 rounded-2xl p-6",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      ...
                      children:
                        "Permanently delete your account, workspace data, saved brands, and outreach history. This action cannot be undone.",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                      disabled: true,
                      className:
                        "px-5 py-2.5 bg-destructive/10 text-destructive font-semibold rounded-xl text-sm border border-destructive/20 opacity-50 cursor-not-allowed",
                      children: "Account Deletion Unavailable",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      className: "text-xs text-muted-foreground mt-3",
                      children:
                        "Complete deletion flows are currently disabled in this preview environment to prevent accidental data loss.",
                    }),
                  ],
                }),
              ],
...
function SubscriptionSettings({ userId, workspaceId }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "max-w-md bg-gradient-to-br from-brand/5 to-muted/20 border border-brand/20 rounded-2xl p-6 shadow-sm",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                    className:
                      "text-xs font-bold text-brand uppercase tracking-wider mb-1",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "w-12 h-12 rounded-full bg-brand/10 flex items-center justify-center",
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  Sparkles,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            className:
              "w-full flex justify-center items-center gap-2 py-2.5 px-4 bg-brand text-brand-foreground rounded-xl text-sm font-semibold hover:bg-brand/90 transition-colors shadow-sm",
