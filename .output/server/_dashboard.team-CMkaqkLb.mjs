...
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.team-CMkaqkLb.js
...
function TeamView({ userId }) {
  ...
  const isAgency =
    wsData?.workspace_type === "agency" || wsData?.type === "agency";
  ...
  if (!isAgency)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className:
        "flex flex-col items-center justify-center h-[60vh] text-center max-w-md mx-auto",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "w-16 h-16 rounded-full bg-muted flex items-center justify-center mb-6",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
          ...
          children:
            "Team management is only available for Agency accounts. You are currently on a Creator account.",
        }),
      ],
    });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "flex flex-col h-full gap-6 lg:gap-8 pb-12 animate-in fade-in duration-500 max-w-5xl mx-auto w-full",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "bg-card border border-border/60 rounded-3xl p-6 subtle-shadow",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
                ...
                teamMembersQuery.isLoading
                  ...
                  : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className: "space-y-4",
                      children: teamMembersQuery.data?.map((member) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          "div",
                          {
                            className:
                              "flex items-center justify-between p-4 rounded-2xl bg-muted/30 border border-border/50",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                "div",
                                {
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      ...
                                      {
                                        className:
                                          "w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center overflow-hidden",
                                        children: member.profiles?.avatar_url
                                          ? /* @__PURE__ */ (0,
                              ...
                              isOwner &&
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                  "button",
                                  {
                                    ...
                                    title: "Remove Member",
                                    children: /* @__PURE__ */ (0,
                                    import_jsx_runtime.jsx)(UserMinus, {
                                      size: 18,
                                    }),
                                  },
                                ),
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      ...
                      disabled:
                        ...
                        !inviteEmail,
                      className:
                        "w-full flex items-center justify-center gap-2 px-4 py-3 bg-foreground text-background font-semibold rounded-xl text-sm hover:bg-foreground/90 transition-all shadow-sm disabled:opacity-50",
                      children: [
                        inviteMemberMutation.isPending
                          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              LoaderCircle,
                    ...
                    !isOwner &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                        className:
                          "text-xs text-center text-muted-foreground flex items-center justify-center gap-1 mt-2",
                        children: [
