...
import { t as BrandProfileModal } from "./_ssr/BrandProfileModal-xyGTd5yg.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.saved-Bi9bPhyS.js
...
function SavedView({ userId, onStartOutreach }) {
  ...
  const [selectedSavedBrand, setSelectedSavedBrand] = (0,
  ...
  const [sortOption, setSortOption] = (0, import_react.useState)(
    "recently_saved",
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "flex flex-col gap-6 lg:gap-8 pb-12 animate-in fade-in duration-500 h-full",
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                    ...
                    className:
                      "w-full pl-10 pr-4 py-3 bg-transparent border-none focus:ring-0 text-base placeholder:text-muted-foreground",
                  }),
                  searchTerm &&
                    ...
                    children: [
                      ...
                      activeFiltersCount > 0 &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          className:
                            "ml-1 flex h-5 w-5 items-center justify-center rounded-full bg-brand text-[10px] text-white",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                        ...
                        className:
                          "w-full sm:w-auto appearance-none bg-muted/50 text-foreground text-sm font-semibold px-4 py-2.5 pr-10 rounded-xl cursor-pointer hover:bg-muted transition-colors border-none focus:ring-2 focus:ring-brand",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "option",
                            {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, {
                        className:
                          "absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground pointer-events-none group-hover:text-foreground",
                      }),
                    ],
                  }),
                ],
          ...
          isFilterOpen &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "bg-card border border-border/60 rounded-2xl p-6 shadow-sm animate-in slide-in-from-top-2 duration-200",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children: Object.entries(filterOptions).map(
                    ([category, options]) =>
                        ...
                        "div",
                        {
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
                              className:
                                "text-xs font-bold text-muted-foreground uppercase tracking-wider mb-3",
                              children: category.replace("_", " "),
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className:
                                "space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                Object.entries(activeFilters).map(([category, values]) =>
                  values.map((val) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      ...
                      {
                        className:
                          "inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-muted/80 text-xs font-medium text-foreground border border-border/50",
                        children: [
                          val,
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "button",
                            {
                              ...
                              children: /* @__PURE__ */ (0,
                              import_jsx_runtime.jsx)(X, { size: 12 }),
                            },
                          ),
                        ],
                      },
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                  onClick: clearFilters,
                  className:
                    "text-xs font-medium text-brand hover:underline ml-2",
                  children: "Clear all",
                }),
              ],
            }),
      ...
      isSavedError
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "flex flex-col items-center justify-center text-center p-12 bg-destructive/5 border border-destructive/20 rounded-3xl",
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                className:
                  "px-6 py-2.5 bg-background border border-border rounded-xl text-sm font-medium hover:bg-muted transition-colors",
                children: "Try again",
              }),
            ],
          })
        : isSavedLoading
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              children: [...Array(4)].map((_, i) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  ...
                  {
                    className:
                      "rounded-3xl border border-border/50 bg-card p-6 h-[320px] animate-pulse flex flex-col justify-between",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className: "h-7 w-2/3 bg-muted rounded-lg mb-4",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className: "h-5 w-1/3 bg-muted rounded-md mb-2",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className: "h-5 w-1/2 bg-muted rounded-md",
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className: "h-11 w-full bg-muted rounded-xl",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className: "h-11 w-full bg-muted rounded-xl",
                          }),
          ...
          : totalCount === 0 && !debouncedSearch && activeFiltersCount === 0
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "flex flex-col items-center justify-center text-center p-16 bg-card border border-border/60 rounded-3xl h-[50vh]",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    className:
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                    to: "/discover",
                    className:
                      "px-6 py-3 bg-brand text-brand-foreground rounded-xl text-sm font-semibold hover:bg-brand/90 transition-colors shadow-sm",
            ...
            : allSavedBrands.length === 0
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "flex flex-col items-center justify-center text-center p-16 bg-card border border-border/60 rounded-3xl",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className:
                        "w-20 h-20 rounded-3xl bg-muted/50 flex items-center justify-center mb-6 border border-border/50 shadow-sm",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        children: allSavedBrands.map((savedRecord) => {
                          ...
                          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            ...
                            {
                              className:
                                "group flex flex-col bg-card rounded-3xl border border-border/60 hover:border-brand/40 overflow-hidden subtle-shadow transition-all hover:-translate-y-1 duration-300",
                              children: /* @__PURE__ */ (0,
                              import_jsx_runtime.jsxs)("div", {
                                className:
                                  "p-6 flex-1 flex flex-col cursor-pointer",
                                onClick: () =>
                                  setSelectedSavedBrand(savedRecord),
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    "div",
                                    {
                                      className:
                                        "flex justify-between items-start mb-4 gap-3",
                                      children: [
                                        /* @__PURE__ */ (0,
                                        import_jsx_runtime.jsx)("h3", {
                                          className:
                                            "text-xl font-bold text-foreground leading-tight line-clamp-2",
                                    ...
                                    "div",
                                    {
                                      ...
                                      children: [
                                        brand.industry &&
                                          ...
                                          import_jsx_runtime.jsx)("span", {
                                            className:
                                              "px-2.5 py-1 bg-muted/50 text-muted-foreground border border-border/50 rounded-lg text-xs font-medium",
                                        ...
                                        brand.country &&
                                          ...
                                          import_jsx_runtime.jsxs)("span", {
                                            className:
                                              "flex items-center gap-1 px-2.5 py-1 bg-muted/50 text-muted-foreground border border-border/50 rounded-lg text-xs font-medium",
                                            children: [
                                              /* @__PURE__ */ (0,
                                              import_jsx_runtime.jsx)(Globe, {
                                                className: "w-3 h-3",
                                              }),
                                              brand.country,
                                            ],
                        ...
                        `,
                                          children: [
                                            /* @__PURE__ */ (0,
                                            import_jsx_runtime.jsx)(Sparkles, {
                                              className: "w-3 h-3",
                                            }),
                                            signal.text,
                                          ],
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    ...
                                    {
                                      className:
                                        "mt-auto mb-6 flex flex-col gap-2",
                                      children: [
                                        brand.influencer_fit_score != null &&
                                          ...
                                          import_jsx_runtime.jsxs)("div", {
                                            children: [
                                              ...
                                              import_jsx_runtime.jsxs)("div", {
                                                className:
                                                  "flex items-center justify-between text-xs text-muted-foreground mb-1.5",
                                                children: [
                                                  /* @__PURE__ */ (0,
                                                  import_jsx_runtime.jsxs)(
                                                    "span",
                                        ...
                                        import_jsx_runtime.jsxs)("div", {
                                          className:
                                            "flex items-center gap-1 text-[11px] text-muted-foreground mt-2",
                                          children: [
                                            /* @__PURE__ */ (0,
                                            import_jsx_runtime.jsx)(Calendar, {
                                              className: "w-3 h-3",
                                            }),
                                            "Saved on",
                                            " ",
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    ...
                                    {
                                      className:
                                        "mt-auto pt-4 border-t border-border/50 flex gap-2",
                                      ...
                                      children: [
                                        ...
                                        import_jsx_runtime.jsx)("button", {
                                          ...
                                          className:
                                            "flex items-center justify-center p-3 rounded-xl text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors",
                                        ...
                                        import_jsx_runtime.jsxs)("button", {
                                          ...
                                          className:
                                            "flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-brand text-brand-foreground rounded-xl text-sm font-semibold hover:bg-brand/90 transition-all shadow-sm",
                                          children: [
                                            /* @__PURE__ */ (0,
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "button",
                            {
                              ...
                              className:
                                "flex items-center gap-2 px-8 py-3 bg-muted text-foreground rounded-xl text-sm font-semibold hover:bg-muted/80 transition-colors border border-border/50 shadow-sm disabled:opacity-50",
