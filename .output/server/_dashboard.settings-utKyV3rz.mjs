...
import { t as PLANS } from "./_ssr/monetization-mD78bnGP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.settings-utKyV3rz.js
...
function useMonetization(userId) {
	const { data: memberData } = useQuery({
		...
		enabled: !!userId,
		queryFn: async () => {
			const { data, error } = await supabase.from("workspace_members").select("workspace_id").eq("user_id", userId).limit(1).single();
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
			...
			children: [
				...
				activeTab === "subscription" && /* @__PURE__ */ (void 0)(SubscriptionSettings, {
					userId,
					workspaceId
				}, void 0, false, {
					fileName: _jsxFileName$1,
