...
//#region node_modules/.nitro/vite/services/ssr/assets/_dashboard.discover-X6qYCCFK.js
...
function AdSlot({ placement, className = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -top-4 -right-4 w-24 h-24 bg-brand/10 rounded-full blur-2xl pointer-events-none" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -bottom-4 -left-4 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl pointer-events-none" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-start gap-4 relative z-10",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "w-12 h-12 bg-background rounded-xl border border-border/50 flex items-center justify-center shrink-0 shadow-sm",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "w-6 h-6 text-brand" })
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2 mb-1",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-[10px] uppercase font-bold tracking-wider text-muted-foreground bg-background px-2 py-0.5 rounded-md border border-border/50",
							children: "Sponsored"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
							className: "font-bold text-foreground",
							children: "Grow your audience faster"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted-foreground mb-3 leading-relaxed",
						children: "Discover advanced tools to monetize your content and reach new brands today. Try Branzly Pro to unlock advanced filters and export capabilities."
					}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			isBrandsError ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				!planConfig?.features?.removeAds && showAd && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mb-8",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdSlot, { placement: "discover-feed" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
