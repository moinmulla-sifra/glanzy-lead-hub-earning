...
import { a as LogOut, c as Earth, d as ArrowLeft, i as Mail, l as Copy, n as RefreshCw, o as Linkedin, r as Pencil, s as Funnel, t as Search, u as ChevronRight } from "../_libs/lucide-react.mjs";
...
function LeadDetails({ lead, onChanged, mobileOpen = false, onMobileClose }) {
	...
	if (!lead) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Select a brand" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Click any lead to view its full details and change the mail status." })
			]
		})
	});
	async function saveMail() {
		if (!lead) return;
		setSavingMail(true);
		const { error } = await supabase.from("brand_leads").update({
			mail,
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { "aria-hidden": "true" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Leads" })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Lead details" })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "details-header",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "details-title",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: fmt(lead.company_name) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
						fmt(lead.industry),
						" · ",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Mail status" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
									...
									children: statusValues.map((v) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
										value: v,
										children: v
									}, v))
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Email draft" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { "aria-hidden": "true" }),
											" ",
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Both" })
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										className: "btn small secondary",
										...
										children: [
											editingEmail ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pencil, { "aria-hidden": "true" }),
											" ",
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: editingEmail ? "Cancel" : "Edit" })
										]
									})
								]
							})]
						}), editingEmail ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								className: "field full",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Body" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "value pre",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "detail-section",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Quick links" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "link-row",
							children: [
								lead.website ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Earth, { "aria-hidden": "true" }), " Website"]
								}) : null,
								lead.linkedin ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									className: "link",
									href: linkHref(lead.linkedin),
									target: "_blank",
									rel: "noopener noreferrer",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Linkedin, { "aria-hidden": "true" }), " LinkedIn"]
								}) : null,
								lead.email ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									className: "link",
									href: `mailto:${lead.email}`,
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, { "aria-hidden": "true" }), " Email"]
								}) : null
							]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "detail-section",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Lead signals" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "field-grid",
							children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "detail-section",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Company" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "field-grid",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
									label: "Contact",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "detail-section",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Why now" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "field",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "detail-section",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Growth signals" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "field-grid",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
...
function Dashboard() {
	...
	const [mobileDetailsOpen, setMobileDetailsOpen] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		let active = true;
	...
	(0, import_react.useEffect)(() => {
		const t = setTimeout(() => setFilters((f) => ({
			...f,
	...
	(0, import_react.useEffect)(() => {
		if (!ready) return;
		const channel = supabase.channel("brand_leads_changes").on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "brand_leads"
		}, () => {
	...
	const selected = (0, import_react.useMemo)(() => rows.find((r) => r.id === selectedId) ?? null, [rows, selectedId]);
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Search, review and update your saved brand leads directly from Supabase." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							onClick: refreshAll,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { "aria-hidden": "true" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Refresh" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							className: "btn danger icon-label-btn",
							onClick: signOut,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogOut, { "aria-hidden": "true" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Sign out" })]
						})
					]
				})]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { "aria-hidden": "true" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "search",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Funnel, { "aria-hidden": "true" }),
							"Filters",
							activeFilterCount ? ` (${activeFilterCount})` : ""
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mobile-filter-grid",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterControls, {
								filters,
								setFilters,
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Saved Brands" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "muted",
								children: leadsQuery.isLoading ? "Loading…" : `${total} match${total === 1 ? "" : "es"}`
							})] }), leadsQuery.error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "error",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Industry" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Lead" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Priority" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Budget" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Mail" })
							] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: leadsQuery.isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								colSpan: 6,
								className: "loading",
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "avatar",
											children: initials(r.company_name)
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "brand-name",
											children: fmt(r.company_name)
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "brand-sub",
											children: fmt(r.email || r.website || r.product)
										})] })]
									}) }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: fmt(r.industry) }),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: fmt(r.budget_potential) }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							"aria-live": "polite",
							children: leadsQuery.isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "loading",
								children: "Loading saved brands…"
							}) : rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "loading",
								children: "No matching brands."
							}) : rows.map((lead) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								type: "button",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												...
												className: "brand-sub",
												children: fmt(lead.industry || lead.product)
											})]
										}),
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Lead score" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: lead.lead_score ?? "—" })] }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Priority" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: fmt(lead.priority) })] }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Budget" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: fmt(lead.budget_potential) })] })
									]
								})]
							}, lead.id))
						}),
...
function FilterControls({ filters, setFilters, industries, stages }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Select, {
			...
			onChange: (priority) => setFilters((f) => ({
				...f,
				priority,
				page: 0
			})),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Select, {
			...
			onChange: (industry) => setFilters((f) => ({
				...f,
				industry,
				page: 0
			})),
			options: [["all", "All industries"], ...industries.map((value) => [value, value])]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Select, {
			value: filters.stage,
			onChange: (stage) => setFilters((f) => ({
				...f,
				stage,
				page: 0
			})),
			options: [["all", "All company stages"], ...stages.map((value) => [value, value])]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Select, {
			value: filters.sort,
			onChange: (sort) => setFilters((f) => ({
				...f,
				sort,
				page: 0
			})),
...
function Select({ value, onChange, options }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
		...
		children: options.map(([v, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
			value: v,
			children: label
		}, v))
	});
...
async function fetchLeads(filters) {
	const run = async (sortKey) => {
		...
		if (term) query = query.or(SEARCH_COLUMNS.map((c) => `${c}.ilike.%${term}%`).join(","));
...
async function fetchOptions() {
	const { data, error } = await supabase.from("brand_leads").select("industry, company_stage").limit(2e3);
	if (error) throw new Error(error.message);
