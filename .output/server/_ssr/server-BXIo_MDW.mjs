...
import { n as globalthis_default } from "../_libs/supabase__realtime-js+unenv.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CyiRMYFX.mjs");
