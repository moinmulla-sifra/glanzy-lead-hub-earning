    ...
    <div className="flex flex-col h-full gap-6 lg:gap-8 animate-in fade-in duration-500">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-card border border-border/60 rounded-2xl p-4 subtle-shadow">
            <div className="flex items-center gap-2 text-muted-foreground mb-2">
              <Activity size={16} />{" "}
              <span className="text-sm font-semibold">Active Contacted</span>
            </div>
      ...
      {contactedQuery.isLoading ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center p-16 bg-card border border-border/60 rounded-3xl">
          ...
          <h2 className="text-2xl font-bold mb-3">No contacted yet</h2>
...
function ContactedDetailPane({
  ...
  const [emailBody, setEmailBody] = useState(contacted.email_body || "");
  const [notes, setNotes] = useState(contacted.notes || "");
  const [nextAction, setNextAction] = useState(contacted.next_action || "");

  // Reset local state when contacted changes
  useEffect(() => {
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground flex items-center gap-4 flex-wrap">
            ...
            {contacted.brand?.country && (
              <span className="flex items-center gap-1.5">
                <Globe size={14} /> {contacted.brand.country}
              </span>
            )}
          </p>
        </div>
                    ...
                    <div className="flex flex-col gap-2 pt-2">
                      ...
                      {contacted.brand.phone && (
                        ...
                        >
                          ...
                          <span>{contacted.brand.phone}</span>
                        </a>
                      )}
                    </div>
                  </div>
